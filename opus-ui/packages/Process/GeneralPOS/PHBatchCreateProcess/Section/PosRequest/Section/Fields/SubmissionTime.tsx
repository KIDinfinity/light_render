...
import { localFieldConfig } from './SubmissionTime.config';

export { localFieldConfig } from './SubmissionTime.config';
...
const SubmissionTime = ({ isShow, layout, form, editable, section }: any) => (
  <Authority>
...
SubmissionTime.displayName = localFieldConfig.field;
