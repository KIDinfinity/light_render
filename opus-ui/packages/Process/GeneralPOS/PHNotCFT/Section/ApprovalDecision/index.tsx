...
const PosApproval = (props: any) => {
  ...
  const isShow = [TaskDefKey.PH_POS_ACT003, TaskDefKey.PH_POS_ACT004].includes(taskDefKey) ||
    isPOSHistory;

  const isNotEditable = !lodash.includes([TaskDefKey.PH_POS_ACT003, TaskDefKey.PH_POS_ACT006], taskDefKey);
...
export default connect(
  ({ GeneralPOSPHNotCFTController, formCommonController, claimEditable, processTask }: any) => ({
    approvalPosDecision:
