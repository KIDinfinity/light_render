...
const LATrack = (props: any) => {
  ...
  const regenerateContractCheck = taskDefKey === TaskDefKey.PH_POS_ACT006 &&
  ...
  const isInforceDeclined = formUtils.queryValue(inforcePosDecision?.decision) === PosDecesionType.Declined;
...
export default connect(
  ({ claimEditable, GeneralPOSPHNotCFTController, processTask, formCommonController }: any) => ({
    ...
    updateTrack: GeneralPOSPHNotCFTController.claimProcessData?.businessData?.transactionTypes?.[0]?.updateTrack || {},
