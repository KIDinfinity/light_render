  ...
  return (
    <div>
      ...
      >
        ...
        <Fields.ShortName transactionId={transactionId} />
...
const FormItem = connect(
  (
    ...
    { transactionId, coverageIndex, id: index }: any
  ) => ({
  ...
  Form.create({
    onFieldsChange(props: any, changedFields: any) {
      const { dispatch, validating, transactionId, coverageIndex, id: index }: any = props;
    ...
    mapPropsToFields(props: any) {
      const { coverageExclusionItem, productCode } = props;
      return formUtils.mapObjectToFields({ ...coverageExclusionItem, productCode });
    },
  })(SectionItem)
);
