...
const SectionDafault = ({ form, editable, children, layoutName, section, layout, formId }: any) => (
  <FormSectionDefault
    section={section}
    layoutName={layoutName}
    form={form}
...
const SectionTable = ({
  ...
  return (
    <TableLayout
      ...
      config={config}
    >
      <TableLayout.Row className={className} rowKey={rowKey} suffixItem={suffixItem}>
        {children}
      </TableLayout.Row>
    </TableLayout>
  );
