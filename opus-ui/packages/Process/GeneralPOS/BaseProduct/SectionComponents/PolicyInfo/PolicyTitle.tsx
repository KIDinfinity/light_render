...
import TransactionInfoSection, { Fields as TransactionInfoFields } from '../TransactionInfo/Section';
...
export default connect(
  ({ formCommonController, [NAMESPACE]: modelnamepsace, processTask }: any, { transactionId }: any) => ({
