...
import { localFieldConfig } from './Freeofcharge.config';

export { localFieldConfig } from './Freeofcharge.config';
...
export const FormItem = ({ isShow, layout, form, editable, field, config, isAdd }: any) => {
  ...
  return (
    ...
    ((config?.visible || fieldProps.visible) === Visible.Conditions
      ...
      <Col {...layout}>
        <FormItemCheckbox
          className={classNames({ [styles.hiddenSvg]: !isAdd }, styles.Freeofcharge)}
          disabled={
            !editable ||
