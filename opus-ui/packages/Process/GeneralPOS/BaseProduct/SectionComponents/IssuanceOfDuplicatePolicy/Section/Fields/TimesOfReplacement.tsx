...
import { localFieldConfig } from './TimesOfReplacement.config';

export { localFieldConfig } from './TimesOfReplacement.config';
...
export const FormItem = ({ isShow, layout, form, editable, field, config }: any) => {
  ...
  const editableConditions =
    ...
    Number(form.getFieldValue('originTimesOfReplacement') || 0) < 1;
