...
import { localFieldConfig } from './RequestDate.config';

export { localFieldConfig } from './RequestDate.config';
...
const RequestDate = ({ isShow, layout, form, editable, config }: any) => (
  <Authority>
    <FormItem
      config={config}
      isShow={isShow}
...
RequestDate.displayName = localFieldConfig.field;
