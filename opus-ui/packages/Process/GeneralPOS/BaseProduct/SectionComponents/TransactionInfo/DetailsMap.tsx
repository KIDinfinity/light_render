...
export default function DetailsMap({
  ...
  const render = useMemo(() => {
    ...
    const tranMap = {
      ...
      SRV019: {
        main: (
          <Reinstatement transactionId={transactionId} transactionTypeCode={transactionTypeCode} />
        ),
      },
      SRV024: {
    ...
    return (
      ...
      >
        ...
        >
          {!isNotDataCapture && <Item transactionId={transactionId} />}
          {isNotDataCapture && (
  ...
  }, [transactionId, transactionTypeCode, notCft, isNotDataCapture]);
  return render;
}
