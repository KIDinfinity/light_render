...
import SectionSearchForm from './SearchForm';
...
const Section = ({ form, editable, children, layoutName, section, NAMESPACE }: any) => (
  <BasicSection
    form={form}
    editable={editable}
    children={children}
...
export { SectionTitle, SectionBasic, SectionSearchForm, localConfig };
