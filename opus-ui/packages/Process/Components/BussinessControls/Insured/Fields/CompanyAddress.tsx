...
import { localFieldConfig } from './CompanyAddress.config';
...
const CompanyAddress = ({ field, config, isShow, layout, form, editable, NAMESPACE, id }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
...
CompanyAddress.displayName = localFieldConfig.field;
