...
import _hook from '../_hooks/IdentityTypeHook';
    ...
    ((config?.visible || fieldProps.visible) === Visible.Conditions
      ...
      <Col {...layout}>
        <FormItemSelect
          dicts={dicts}
          disabled={
            !editable || (config?.editable || fieldProps.editable) === Editable.Conditions
              ? !editableConditions
...
const IdentityType = ({ field, config, isShow, layout, form, editable, NAMESPACE, id }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
