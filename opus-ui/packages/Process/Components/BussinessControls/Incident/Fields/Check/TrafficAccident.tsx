...
import { localFieldConfig } from './TrafficAccident.config';

export { localFieldConfig } from './TrafficAccident.config';
...
const TrafficAccident = ({ field, config, isShow, layout, form, editable, NAMESPACE, id }: any) => (
  <Authority>
