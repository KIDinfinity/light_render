...
import { localFieldConfig } from './RelatedToAlcohol.config';

export { localFieldConfig } from './RelatedToAlcohol.config';
...
const RelatedToAlcohol = ({ field, config, isShow, layout, form, editable, NAMESPACE, id }: any) => (
  <Authority>
