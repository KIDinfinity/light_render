...
import { localFieldConfig } from './PassbookNo.config';
...
const PassbookNo = ({ field, config, form, editable, layout, isShow, id, NAMESPACE }: any) => (
  <Authority>
    <FormItem
...
PassbookNo.displayName = localFieldConfig.field;

export default PassbookNo;
