...
import FormFields, { localFieldConfigs as FormFieldConfigs } from './Fields/Form';
...
const localConfig = {
  configs: [localSectionConfig, ...FieldConfigs, ...FormFieldConfigs],
  remote: true,
};
...
export { Fields, FormFields, SectionTitle, localConfig };
