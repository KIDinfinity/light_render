...
const TreamentPayableAmount = ({ field, config, isShow, layout, form, editable, data }: any) => (
  <Authority>
    <FormItem field={field} config={config} isShow={isShow} layout={layout} form={form} editable={editable} data={data} />
  </Authority>
);

TreamentPayableAmount.displayName = 'PayableAmount';

export default TreamentPayableAmount;
