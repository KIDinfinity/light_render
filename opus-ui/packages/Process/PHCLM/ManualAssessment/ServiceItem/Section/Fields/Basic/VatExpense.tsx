...
const VatExpense = ({ field, config, isShow, layout, form, editable, serviceItemId }: any) => (
  <Authority>
    <FormItem field={field} config={config} isShow={isShow} layout={layout} form={form} editable={editable} serviceItemId={serviceItemId} />
  </Authority>
);

VatExpense.displayName = 'VatExpense';
