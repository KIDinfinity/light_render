...
const localConfig = {
  configs: [localSectionConfig, ...PayableFieldConfigs, ...BasicFieldConfigs, ...AddFieldConfigs],
...
export { PayableFields, BasicFields, AddFields, SectionTitle, SectionColumns, localConfig };
