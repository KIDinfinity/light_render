...
const MainBenifitListItem = ({ form, mainBenefitId, treatmentId }: any) => {
  ...
  return (
    <FormBorderCard
      border={{ type: 'weight', visiable: true }}
      marginBottom
      background={{ visiable: true }}
      button={{ visiable: editable, callback: handleDelete }}
    >
      <Section form={form} editable={editable} section="MainBenefit">
        <Fields.TherapiesTypeMainBenefit treatmentId={treatmentId} />
