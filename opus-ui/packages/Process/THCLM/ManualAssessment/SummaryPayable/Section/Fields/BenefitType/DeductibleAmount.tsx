...
const DeductibleAmount = ({ field, config, isShow, layout, form, editable, benefitTypeData }: any) => (
  <Authority>
    <FormItem field={field} config={config} isShow={isShow} layout={layout} form={form} editable={editable} benefitTypeData={benefitTypeData} />
  </Authority>
);
