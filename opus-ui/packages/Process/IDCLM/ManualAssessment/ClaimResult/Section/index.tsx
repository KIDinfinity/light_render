...
const SectionLayout = ({ config, layoutName, justify, form, children }: any) => (
  <FixedFieldLayout config={config} layoutName={layoutName} form={form} justify={justify}>
    {children}
  </FixedFieldLayout>
);

const FormSection = ({ form, section, justify, layoutName, children }: any) => {
    ...
    <div>
      <FormRegister form={form}>
        <Form layout="vertical">
          <SectionLayout layoutName={layoutName} form={form} justify={justify} config={config}>
            {children}
          </SectionLayout>
        </Form>
      </FormRegister>
...
const Section = ({ form, editable, children, layoutName, section, justify }: any) => (
  <FormSection section={section} layoutName={layoutName} form={form} justify={justify}>
