...
enum PayableListMapEnum {
  ...
  OPTreatment = 'opTreatmentPayableListMap',
...
const mapToPayableListMap = {
  ...
  [BenefitCategoryEnum.LumpSum]: PayableListMapEnum.Treatment,
  'COP': PayableListMapEnum.OPTreatment,
};
