...
import useGetChequeAllocationAmountDisabled from 'process/NB/Share/hooks/useGetChequeAllocationAmountDisabled';
...
const ChequeTable = () => {
  ...
  const chequeAllocationAmountDisabled = useGetChequeAllocationAmountDisabled();
    ...
    return transTableRowsConfigEditable({
      ...
      operations: {
        chequeAllocationAmount: {
          ...
          disabled: chequeAllocationAmountDisabled,
        },
      },
    });
  }, [config, handleChange, chequeAllocationAmountDisabled]);
