...
import { fieldConfig } from './Portfoliotype.config';

export { fieldConfig } from './Portfoliotype.config';
...
const FormItem = ({ isShow, layout, form, editable, field, config }: any) => {
  ...
  const requiredConditions = autoAttachFundStatus;
...
const Portfoliotype = ({ field, config, form, editable, layout, isShow }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
