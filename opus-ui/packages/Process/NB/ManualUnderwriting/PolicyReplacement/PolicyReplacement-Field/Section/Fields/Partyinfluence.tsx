...
import { fieldConfig } from './Partyinfluence.config';

export { fieldConfig } from './Partyinfluence.config';
...
const Partyinfluence = ({ field, config, form, editable, layout, isShow }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
...
Partyinfluence.displayName = 'partyInfluence';

export default Partyinfluence;
