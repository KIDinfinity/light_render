...
describe('useGetTransferModalButtonWarning', () => {
  test('has failed status', () => {
    const renderer = renderHook(() => useGetTransferModalButtonWarning());
  ...
  test('not handle status', () => {
    const renderer = renderHook(() => useGetTransferModalButtonWarning());

    expect(renderer.result.current).toBeTruthy();
  });

  test('all status in success and canceled', () => {
    const renderer = renderHook(() => useGetTransferModalButtonWarning());
