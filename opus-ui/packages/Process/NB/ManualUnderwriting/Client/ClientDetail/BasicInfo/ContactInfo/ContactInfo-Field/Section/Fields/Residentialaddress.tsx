...
import { fieldConfig } from './Residentialaddress.config';

export { fieldConfig } from './Residentialaddress.config';
...
const Residentialaddress = ({ form, editable, layout, isShow, id, config }: any) => {
  return (
    <Authority>
      <FormItem
...
Residentialaddress.displayName = 'residentialAddress';
