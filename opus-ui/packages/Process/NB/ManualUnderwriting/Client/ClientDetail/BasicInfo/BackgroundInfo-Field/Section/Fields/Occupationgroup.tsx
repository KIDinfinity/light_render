...
import useGetOccupationGroupDicts from 'process/NB/ManualUnderwriting/_hooks/useGetOccupationGroupDicts';
...
const FormItem = ({ isShow, layout, form, editable, field, config, id }: any) => {
  ...
  const dicts = useGetOccupationGroupDicts({ id, config });
