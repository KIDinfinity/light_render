...
import { fieldConfig } from './Businessaddress.config';

export { fieldConfig } from './Businessaddress.config';
...
const Businessaddress = ({ form, editable, layout, isShow, id, config }: any) => {
  return (
    <Authority>
      <FormItem
