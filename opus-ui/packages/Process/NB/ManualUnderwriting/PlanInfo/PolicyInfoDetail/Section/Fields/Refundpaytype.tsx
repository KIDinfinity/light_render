...
import useGetRefundPayTypeDicts from 'process/NB/ManualUnderwriting/_hooks/useGetRefundPayTypeDicts';

const FormItem = ({ isShow, layout, form, editable, field, config }: any) => {
  const fieldProps: any = fieldConfig['field-props'];
  const dicts = useGetRefundPayTypeDicts();
...
const Refundpaytype = ({ form, editable, layout, isShow, config }: any) => (
  <Authority>
    <FormItem
      isShow={isShow}
      layout={layout}
