...
import { localFieldConfig } from './IdentityNumber.config';

export { localFieldConfig } from './IdentityNumber.config';
...
const IdentityNumber = ({ isShow, layout, form, editable, section, id }: any) => (
  <Authority>
...
IdentityNumber.displayName = localFieldConfig.field;
