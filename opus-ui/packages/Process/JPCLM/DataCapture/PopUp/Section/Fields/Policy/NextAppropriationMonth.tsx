...
export const fieldConfig = {
  ...
  field: 'nextAppropriationMonth',
  'field-props': {
    label: {
      dictTypeCode: 'Label_BIZ_Policy',
      dictCode: 'Nextappropriationmonth',
    },
    editable: 'N',
    required: 'N',
    visible: 'Y',
...
const NextAppropriationMonth = ({ field, config, form, editable, layout, isShow }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
...
NextAppropriationMonth.displayName = 'nextAppropriationMonth';

export default NextAppropriationMonth;
