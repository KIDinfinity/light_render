...
const localFieldConfig = {
  ...
  field: 'unpaidInterestFlg',
  'field-props': {
    editable: 'Y',
    label: {
      dictTypeCode: 'Label_BIZ_Claim',
      dictCode: 'NonInterest',
    },
    required: 'N',
    visible: 'Y',
    'x-dict': {
      dictTypeCode: 'Dropdown_CLM_NonInterest',
    },
    'x-layout': {
      // 480px
      xs: {
...
const UnpaidInterestFlg = ({ field, config, form, editable, layout, isShow }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
...
UnpaidInterestFlg.displayName = 'unpaidInterestFlg';

export default UnpaidInterestFlg;
