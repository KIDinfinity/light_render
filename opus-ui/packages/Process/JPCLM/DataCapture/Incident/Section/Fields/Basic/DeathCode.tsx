...
const localFieldConfig = {
  ...
  'field-props': {
    ...
    'x-dict': { dictTypeCode: 'Dropdown_CLM_deathCode' },
    'x-layout': {
      //  TODO: 动态layout
      // 480px
      xs: {
...
const DeathCode = ({ field, config, isShow, layout, form, editable }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
...
DeathCode.displayName = localFieldConfig.field;

export default DeathCode;
