...
const FormItem = ({ isShow, layout, form, editable, config, field, incidentId }: any) => {
  ...
  const getIncidentDate = (state: any) =>
    state.JPCLMOfClaimAssessment.claimEntities.incidentListMap[incidentId]?.incidentDate;
  const getDateTimeOfDeath = (state: any) =>
    state.JPCLMOfClaimAssessment.claimProcessData.insured.dateTimeOfDeath;
