...
export const fieldConfig = {
  ...
  field: 'specialContractType',
  'field-props': {
    label: {
      dictTypeCode: 'Label_BIZ_Policy',
      dictCode: 'Specialcontracttype',
    },
    editable: 'N',
    required: 'N',
    visible: 'Y',
...
const SpecialContractType = ({ field, config, form, editable, layout, isShow }: any) => (
  <Authority>
    <FormItem field={field} config={config} isShow={isShow} layout={layout} form={form} editable={editable} />
  </Authority>
);

SpecialContractType.displayName = 'specialContractType';

export default SpecialContractType;
