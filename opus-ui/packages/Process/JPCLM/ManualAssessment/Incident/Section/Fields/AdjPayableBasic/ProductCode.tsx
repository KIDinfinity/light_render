...
export const FormItem = ({ isShow, layout, form, editable, field, config, isDeclined }: any) => {
...
const ProductCode = ({ field, config, isShow, layout, form, editable, isDeclined }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
