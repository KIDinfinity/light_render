...
const localFieldConfig = {
  ...
  'field-props': {
    ...
    label: {
      ...
      dictCode: 'mentalState',
    },
    'x-dict': { dictTypeCode: 'Dropdown_CLM_mentalGrade' },
    'x-layout': {
      //  TODO: 动态layout
      // 480px
      xs: {
...
const MentalState = ({ field, config, isShow, layout, form, editable }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
...
MentalState.displayName = localFieldConfig.field;
