...
export const FormItem = ({ isShow, layout, form, editable, field, config }: any) => {
  ...
  return (
    ...
    ((config?.visible || fieldProps.visible) === Visible.Conditions
      ...
      <Col {...layout}>
        {form.getFieldValue('benefitSubCategory') === BenefitSubCategory.OP ? (
          <FormItemSelect
            dicts={[
              {
                dictCode: '-1',
...
const AssessorOverrideDays = ({ field, config, isShow, layout, form, editable }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
...
AssessorOverrideDays.displayName = localFieldConfig.field;
