...
import { localFieldConfig } from './UsCitizenTaxIdentityNo.config';

export { localFieldConfig } from './UsCitizenTaxIdentityNo.config';
...
const UsCitizenTaxIdentityNo = ({ field, config, isShow, layout, form, editable, ...rest }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
...
UsCitizenTaxIdentityNo.displayName = localFieldConfig.field;

export default UsCitizenTaxIdentityNo;
