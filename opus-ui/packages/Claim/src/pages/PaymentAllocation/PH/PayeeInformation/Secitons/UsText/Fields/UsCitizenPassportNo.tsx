...
import { localFieldConfig } from './UsCitizenPassportNo.config';

export { localFieldConfig } from './UsCitizenPassportNo.config';
...
const UsCitizenPassportNo = ({ field, config, isShow, layout, form, editable,item }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
...
UsCitizenPassportNo.displayName = localFieldConfig.field;

export default UsCitizenPassportNo;
