...
const BankAccountItem: FunctionComponent<IBankAccount> = ({
  ...
  const bankCodeCache = bankAccountItem?.bankCodeCache;
            ...
            <FormItemSelect
              ...
              rules={[
                Validator.VLD_000882(
                  Object.values(incidentListMap || {}).findIndex(
                    (i: any) => i.claimType === 'WOP'
                  ) > -1,
...
export default connect(
  ({ claimEditable, formCommonController, dictionaryController, opusClaimAssessment }: any) => ({
    incidentListMap: opusClaimAssessment.claimEntities.incidentListMap,
    claimDecision: lodash.get(opusClaimAssessment, 'claimProcessData.claimDecision'),
