...
export default [
  ...
  },
  {
    ...
    taskDefKey: {
      JP_CLM_ACT001: lazy(() => import('opus/Pages/Process/Claim/DataCapture/Entry')),
      JP_CLM_ACT003: lazy(() => import('opus/Pages/Process/Claim/ManualAssessment/Entry')),
      JP_CLM_ACT004: lazy(() => import('opus/Pages/Process/Claim/ClaimApprove/Entry')),
      JP_CLM_ACT005: lazy(() => import('opus/Pages/Process/Claim/QualityControl/Entry')),
    },
  },
  {
    caseCategory: CaseCategory.JP_CLM_CTG004,
    taskDefKey: {
      JP_CLM_ACT003: lazy(() => import('opus/Pages/Process/Claim/FollowUpManualAssessment/Entry')),
      JP_CLM_ACT004: lazy(() => import('opus/Pages/Process/Claim/ClaimApprove/Entry')),
      JP_CLM_ACT005: lazy(() => import('opus/Pages/Process/Claim/QualityControl/Entry')),
    },
  },
  {
    caseCategory: [CaseCategory.JP_CLM_CTG006, CaseCategory.JP_CLM_CTG005],
    taskDefKey: {
      JP_CLM_ACT011: lazy(() => import('opus/Pages/Process/Claim/NonOpusSupportedClaim/Entry')),
      JP_CLM_ACT010: lazy(() => import('opus/Pages/Process/Claim/NonOpusSupportedClaim/Entry')),
      JP_CLM_ACT001: lazy(() => import('opus/Pages/Process/Claim/NonOpusSupportedClaim/Entry')),
      JP_CLM_ACT003: lazy(() => import('opus/Pages/Process/Claim/NonOpusSupportedClaim/Entry')),
      JP_CLM_ACT004: lazy(() => import('opus/Pages/Process/Claim/NonOpusSupportedClaim/Entry')),
      JP_CLM_ACT005: lazy(() => import('opus/Pages/Process/Claim/NonOpusSupportedClaim/Entry')),
      JP_CLM_ACT006: lazy(() => import('opus/Pages/Process/Claim/NonOpusSupportedClaim/Entry')),
    },
  },
  {
    caseCategory: [CaseCategory.JP_CLM_CTG007],
    taskDefKey: {
      JP_CLM_ACT012: lazy(() => import('opus/Pages/Process/Claim/NonOpusSupportedClaim/Entry')),
    },
  },
  {
    caseCategory: CaseCategory.JP_CLM_CTG003,
    taskDefKey: {
      JP_CLM_ACT009: lazy(() => import('opus/Pages/Process/Claim/QualityControl/Entry')),
    },
  },
  {
  ...
  {
    caseCategory: CaseCategory.BP_VAN_CTG001,
    taskDefKey: {
      BP_VAN_ACT001: lazy(
        () => import('claimBasicProduct/pages/SimplifiedDigital/CaseCreation/Entry')
      ),
  ...
  },
  {
    ...
    taskDefKey: {
      [TaskDefKey.HK_DC_ACT001]: lazy(
        () => import('opus/Pages/Process/Claim/DocumentScanning/Entry')
      ),
    },
  },
  {
  ...
  // NB
  {
    ...
    taskDefKey: {
      ...
      BP_NB_ACT002: lazy(() => import('opus/NewBusiness/CustomerIdentification/Entry')),
      BP_NB_ACT004: lazy(() => import('opus/NewBusiness/ManualUnderwriting/Entry')),
      BP_NB_ACT006: lazy(() => import('opus/NewBusiness/PremiumSettlement/Entry')),
      BP_NB_ACT008: lazy(() => import('opus/NewBusiness/QualityControl/Entry')),
    },
  },
  // Test NB
  {
  ...
  },
  {
    ...
    taskDefKey: {
      VN_UW_ACT001: lazy(() => import('opus/NewBusiness/ManualUnderwriting/Entry')),
    },
  },
  ...
  },
  {
    ...
    taskDefKey: {
      BP_AP_ACT003: lazy(() => import('opus/NewBusiness/ManualUnderwriting/Entry')),
      BP_AP_ACT005: lazy(() => import('opus/NewBusiness/PremiumSettlement/Entry')),
    },
  },
  {
  ...
  },
  {
    ...
    taskDefKey: {
      NB_UW_ACT001: lazy(() => import('opus/NewBusiness/ManualUnderwriting/Entry')),
    },
  },
  {
    caseCategory: CaseCategory.NB_UW_CTG005,
    taskDefKey: {
      NB_UW_ACT002: lazy(() => import('opus/NewBusiness/ManualUnderwriting/Entry')),
    },
  },
  {
  ...
  {
    caseCategory: CaseCategory.TH_PAPER_CTG001,
    taskDefKey: {
      TH_PAPER_ACT001: lazy(() => import('opus/Pages/Process/NewBusiness/DataEntry/Entry')),
    },
  },
  // HK POS
  {
    caseCategory: [
      ...
      CaseCategory.HK_POS_CTG003,
      CaseCategory.BP_POS_CTG011,
      CaseCategory.BP_CDD_CTG001,
    ],
    taskDefKey: {
      HK_PAPER_ACT002: lazy(() => import('opus/Pages/Process/POS/DataCapture/Entry')),
      HK_PAPER_ACT003: lazy(() => import('opus/Pages/Process/POS/DataVerification/Entry')),
      HK_POS_ACT002: lazy(() => import('opus/Pages/Process/POS/ManualAssessment/Entry')),
      HK_POS_ACT003: lazy(() => import('opus/Pages/Process/POS/Approval/Entry')),
      HK_POS_ACT007: lazy(() => import('opus/Pages/Process/POS/QualityAssurance/Entry')),
      BP_POS_ACT009: lazy(() => import('opus/Pages/Process/POS/QualityCheck/Entry')),
      BP_CDD_ACT001: lazy(() => import('opus/Pages/Process/POS/AMLAssessment/Entry')),
      BP_CDD_ACT002: lazy(() => import('opus/Pages/Process/POS/AMLApproval/Entry')),
    },
  },
];
