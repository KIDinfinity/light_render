...
@connect(
  (
    ...
    const { claimDecision } = daOfClaimAssessmentController.claimEntities.claimPayableListMap[
      tempTreatment.payableId
    ];
        ...
        <Form layout="vertical">
          <FormLayout json={claimPayableWithTreatmentLayout}>
            ...
            <FormItemSelect
              ...
              onChange={(e: any) => {this.handleBenefitItemCode({benefitItemCode: e})}}
            />
            <FormItemNumber
              form={form}
              disabled={taskNotEditable || isDeclined}
              ...
              onChange={(e: any) => {this.handlePayableDays({payableDays: e})}}
              min={0}
              max={999}
            />
          </FormLayout>
