...
const mapStateToProps = (
  ...
  return {
    ...
    accidentBenefitPayableList:
      daOfClaimAssessmentController.claimEntities.treatmentPayableListMap[treatmentPayableId]
        .accidentBenefitPayableList,
    idAssemble,
    fullyClaim,
    taskNotEditable: claimEditable.taskNotEditable,
    accidentBenefitPayableListMap:
      daOfClaimAssessmentController.claimEntities.accidentBenefitPayableListMap,
  };
};
...
class AccidentBenefitPayableList extends Component {
  ...
  handleAdd = () => {
    ...
    dispatch({
      type: 'daOfClaimAssessmentController/addAccidentBenefitPayableItem',
      payload: {
        idAssemble,
      },
    });
