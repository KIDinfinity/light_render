...
import Tenant, { tenant, Region } from '@/components/Tenant';
...
@connect(
  ({ daOfClaimAssessmentController, user, formCommonController, dictionaryController }: any) => ({
...
class DAOfAssessment extends Component<IProps, IState> {
  ...
  render() {
    ...
    const { claimProcessData, dictsClaimType, listPolicy, taskDetail, payeeList }: any = this.props;
    const caseCategory = lodash.get(claimProcessData, 'caseCategory');
