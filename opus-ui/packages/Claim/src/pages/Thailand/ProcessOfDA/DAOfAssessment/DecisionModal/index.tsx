...
@connect(({ daOfClaimAssessmentController }) => ({
  decisionModalShowStatus: daOfClaimAssessmentController.decisionModalShowStatus,
}))
class DecisionModal extends Component {
  ...
  hideConfirmModal = () => {
    ...
    dispatch({ type: 'daOfClaimAssessmentController/hideDecisionModal' });
  };
