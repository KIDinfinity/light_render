...
@connect(
  (
    { apOfClaimAssessmentController, formCommonController, claimEditable }: any,
    { treatmentId, incidentId }: any
  ) => ({
    treatmentItem: apOfClaimAssessmentController.claimEntities.treatmentListMap[treatmentId],
    ...
    submissionDate: apOfClaimAssessmentController.claimProcessData.submissionDate,
    assessmentDecision: apOfClaimAssessmentController.claimProcessData?.claimDecision?.assessmentDecision || '',
...
class TreatmentListItemOfBasicInfo extends Component<IProps> {
  ...
  render() {
    const { form, incidentItem, taskNotEditable, submissionDate, caseCategory, assessmentDecision }: any = this.props;
