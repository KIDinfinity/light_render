...
@connect(({ apOfClaimAssessmentController }) => ({
  decisionModalShowStatus: apOfClaimAssessmentController.decisionModalShowStatus,
}))
class DecisionModal extends Component {
  ...
  hideConfirmModal = () => {
    ...
    dispatch({ type: 'apOfClaimAssessmentController/hideDecisionModal' });
  };
