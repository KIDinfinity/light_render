...
export const config = {
  ...
  pend: loadable(async () => (await import('bpm/assets/opus-pend.svg'))?.ReactComponent),
  ...
  cancel: loadable(async () => (await import('bpm/assets/cancel-task.svg'))?.ReactComponent),
  ...
  qcPass: loadable(async () => (await import('bpm/assets/sidebarConfirm.svg'))?.ReactComponent),
  qaPass: loadable(async () => (await import('bpm/assets/sidebarConfirm.svg'))?.ReactComponent),
  qcFail: loadable(async () => (await import('bpm/assets/close.svg'))?.ReactComponent),
  qaFail: loadable(async () => (await import('bpm/assets/close.svg'))?.ReactComponent),
  nameScreening: loadable(
    async () => (await import('bpm/assets/nameScreening.svg'))?.ReactComponent
  ),
  reAssessment: loadable(async () => (await import('bpm/assets/reAssessment.svg'))?.ReactComponent),
  changeHospitalizationNumber: loadable(
    async () => (await import('bpm/assets/changeHospitalizationNumber.svg'))?.ReactComponent
  ),
  claimReversal: loadable(
    async () => (await import('bpm/assets/claimReversal.svg'))?.ReactComponent
  ),
  premiumTransfer: loadable(
    async () => (await import('bpm/assets/premiumTransfer.svg'))?.ReactComponent
  ),
  reopen: loadable(async () => (await import('bpm/assets/reopen.svg'))?.ReactComponent),
  recal: loadable(async () => (await import('bpm/assets/escalate.svg'))?.ReactComponent),
  reUW: loadable(async () => (await import('bpm/assets/escalate.svg'))?.ReactComponent),
  'Re-underwrite': loadable(
    async () => (await import('bpm/assets/InteractionOutlined.svg'))?.ReactComponent
  ),
  'Re-calculate': loadable(
    async () => (await import('bpm/assets/CalculatorOutlined.svg'))?.ReactComponent
  ),
  Refresh: loadable(async () => (await import('bpm/assets/reAssessment.svg'))?.ReactComponent),
};
