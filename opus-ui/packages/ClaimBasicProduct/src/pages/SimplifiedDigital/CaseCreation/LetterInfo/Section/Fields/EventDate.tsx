...
import { localFieldConfig } from './EventDate.config';

export { localFieldConfig } from './EventDate.config';
...
const EventDate = ({ isShow, layout, form, editable, section }: any) => (
  <Authority>
...
EventDate.displayName = localFieldConfig.field;
