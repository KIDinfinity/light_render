...
import { localFieldConfig } from './State.config';

export { localFieldConfig } from './State.config';
...
const ZipCode = ({ isShow, layout, form, editable, section, transactionId }: any) => (
  <Authority>
    <ElementConfig.Field config={localConfig} section={section} field={localFieldConfig.field}>
      <FormItem isShow={isShow} layout={layout} form={form} editable={editable} transactionId={transactionId} />
    </ElementConfig.Field>
  </Authority>
);
