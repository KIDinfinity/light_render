...
@connect(({ bpOfClaimAssessmentController, claimEditable }: any, { invoiceId }: any) => ({
  serviceItemList:
    bpOfClaimAssessmentController.claimEntities.invoiceListMap[invoiceId].serviceItemList,
  taskNotEditable: claimEditable.taskNotEditable,
  serviceItemListMap: bpOfClaimAssessmentController.claimEntities.serviceItemListMap,
}))
