...
import useHandleGetQuestionnaireDefaultClientName from 'opus/NewBusiness/ManualUnderwriting/_hooks/useHandleGetQuestionnaireDefaultClientName';
    ...
    ?.map((item: any) => {
      const clientName =
        isNB && !isAgentName
          ...
          : `${item.clientInfo.firstName}${item.clientInfo.surname}`;
