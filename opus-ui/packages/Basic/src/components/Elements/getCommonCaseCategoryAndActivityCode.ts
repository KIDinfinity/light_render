...
const getCommonCaseCategoryAndActivityCode = ({
  ...
  const commonConfigMapping = {
    ...
    JPNonOpusPostProcessing: {
      caseCategory: 'JP_CLM_CTG007',
      activityCode: 'JP_CLM_ACT012',
    },
    HKPOSDataCapture: {
      caseCategory: 'HK_PAPER_CTG001',
      activityCode: 'HK_PAPER_ACT002',
    },
    HKPOSDecision: {
      caseCategory: 'HK_POS_CTG001',
      activityCode: 'HK_POS_ACT002',
    },
  };
  ...
  const pageMapping = {
    ...
    JP_CLM_CTG004: 'JPQCFollowUpManualAssessment',
    ...
    'JP_CLM_CTG002.JP_CLM_ACT003': 'JPManualAssessment',
    'JP_CLM_CTG004.JP_CLM_ACT004': 'JPQCFollowUpManualAssessment',
    'JP_CLM_CTG004.JP_CLM_ACT005': 'JPQCFollowUpManualAssessment',
    'JP_CLM_CTG006.JP_CLM_ACT011': 'JPNonOpusSupport',
    'JP_CLM_CTG005.JP_CLM_ACT010': 'JPNonOpusSupport',
    'JP_CLM_CTG005.JP_CLM_ACT001': 'JPNonOpusSupport', // Data Capture
    'JP_CLM_CTG005.JP_CLM_ACT003': 'JPNonOpusSupport', // Assessment
    'JP_CLM_CTG005.JP_CLM_ACT004': 'JPNonOpusSupport', // High Approval
    'JP_CLM_CTG005.JP_CLM_ACT005': 'JPNonOpusSupport', // Quality Assurance
    'JP_CLM_CTG005.JP_CLM_ACT006': 'JPNonOpusSupport', // Settlement
    'JP_CLM_CTG007.JP_CLM_ACT012': 'JPNonOpusPostProcessing', // post processing
    JP_CLM_CTG005: 'JPNonOpusSupport',
    JP_CLM_CTG006: 'JPNonOpusSupport',
    JP_CLM_CTG007: 'JPNonOpusPostProcessing',
    ...
    'BP_NB_CTG001.BP_NB_ACT002': 'THManualUnderwriting',
    'BP_NB_CTG002.BP_NB_ACT008': 'KHCustomerIdentification',
    'BP_NB_CTG003.BP_NB_ACT008': 'THQualityControl',
    ...
    'HK_PAPER_CTG001.history': 'HKPOSDataCapture',
    'HK_POS_CTG001.history': 'HKPOSDecision',
    'HK_POS_CTG003.history': 'HKPOSDecision',
    HK_PAPER_CTG001: 'HKPOSDataCapture',
    HK_POS_CTG001: 'HKPOSDecision',
    HK_POS_CTG003: 'HKPOSDecision',
    ...tenant.region({
      [Region.PH]: {
  ...
  if (window.location.pathname.includes('/nb/uw/ews')) {
    ...
    const eworksheetMapping =
      tenant.isMY() && userInfo?.companyCode?.join('') === '5'
  ...
  const template: string | undefined =
    ...
    !lodash.isEmpty(searchParams.get('caseCategory') || params?.caseCategory) &&
    window.location.pathname.includes('/history')
      ? pageMapping[`${searchParams.get('caseCategory') || params?.caseCategory}`]
