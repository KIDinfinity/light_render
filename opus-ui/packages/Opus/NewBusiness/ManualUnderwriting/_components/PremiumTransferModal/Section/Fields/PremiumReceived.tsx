...
import { localFieldConfig } from './PremiumReceived.config';

export { localFieldConfig } from './PremiumReceived.config';
...
const Comp = ({ isShow, layout, form, editable, section }: any) => (
  <Authority>
