...
import PolicyTermDisplayType from 'opus/NewBusiness/ManualUnderwriting/_enum/PolicyTermDisplayType.ts';
import PolicyTermType from 'opus/NewBusiness/ManualUnderwriting/_enum/PolicyTermType.ts';
