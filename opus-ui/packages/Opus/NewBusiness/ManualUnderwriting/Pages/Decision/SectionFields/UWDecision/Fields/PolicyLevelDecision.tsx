...
import useGetPolicyLevelDecisionDropdown from 'packages/Opus/NewBusiness/ManualUnderwriting/Pages/Decision/_hooks/useGetPolicyLevelDecisionDropdown';
...
import useHandleDecisionChange from 'decision/_hooks/useHandleDecisionChange';
...
const FormItem = ({ isShow, layout, form, editable, field, config }: any) => {
  ...
  const handleChange = useHandleDecisionChange();
    ...
    ((config?.visible || fieldProps.visible) === Visible.Conditions
      ...
      <Col {...layout}>
        <FormItemSelect
          ...
          hiddenPrefix
          precision={0}
          onChange={(value) => handleChange({ uwDecision: value })}
          placeholder=" "
        />
      </Col>
    )
