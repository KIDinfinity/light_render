...
import Decisionlaowcode, { fieldConfig as decisionLaOwCodeConfig } from './Fields/Decisionlaowcode';

import Decisionuwcode, { fieldConfig as decisionUwCodeConfig } from './Fields/Decisionuwcode';

import Decisionaggregatedcode, {
  fieldConfig as decisionAggregatedCodeConfig,
} from './Fields/Decisionaggregatedcode';
...
const localConfig = {
  configs: [
    ...
    decisionLaOwCodeConfig,
    decisionUwCodeConfig,
    decisionAggregatedCodeConfig,
  ],
  remote: true,
};

const Section = ({ section, form, children, showOnly }: any) => {
  ...
  return (
    <FormRegister form={form}>
      <Form layout="vertical">
        <FixedFieldLayout config={config} showOnly={showOnly}>
          {children}
        </FixedFieldLayout>
      </Form>
    </FormRegister>
...
const UWDecision = ({ form, editable, children, showOnly }: any) => (
  <Section section="UWDecision" form={form} showOnly={showOnly}>
