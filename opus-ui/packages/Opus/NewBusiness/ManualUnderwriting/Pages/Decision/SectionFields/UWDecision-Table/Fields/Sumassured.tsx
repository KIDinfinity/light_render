...
import useHandleSumAssuredChangeCallback from 'decision/Edit/_hooks/useHandleSumAssuredChangeCallback';
...
const FormItem = ({
  ...
  useEffect(() => {
    if (isShowAnnualLimit) {
      dispatch({
        type: `${NAMESPACE}/clearFieldErrorLog`,
