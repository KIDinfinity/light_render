...
import ReasonInd, { fieldConfig as ReasonIndConfig } from './Fields/ReasonInd';
...
const Loadingfield = ({ form, editable, children, id, coverageId }: any) => (
  <Section section="Loading-Field" form={form}>
    {React.Children.map(children, (child: any) =>
      React.cloneElement(child, { id, coverageId, form, editable, section: 'Loading-Field' })
    )}
  </Section>
);
const Fields = {
