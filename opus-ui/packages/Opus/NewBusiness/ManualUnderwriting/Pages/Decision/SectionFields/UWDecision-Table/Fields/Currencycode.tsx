...
import { fieldConfig } from './Currencycode.config';

export { fieldConfig } from './Currencycode.config';
...
const Currencycode = ({ field, config, form, editable, layout, isShow, disabled }: any) => (
  <Authority>
    <FormItem
      field={field}
