...
import useGetRelateJointLifeCoverageInsuredId from 'opus/NewBusiness/ManualUnderwriting/Pages/Decision/components/Benefit/components/CoverageList/_hooks/useGetRelateJointLifeCoverageInsuredId';
