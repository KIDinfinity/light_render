...
import useGetCoverageDataSource from 'opus/NewBusiness/ManualUnderwriting/Pages/Decision/components/Benefit/_hooks/useGetCoverageDataSource';
import useGetCurrentContractTypeProductDicts from 'opus/NewBusiness/ManualUnderwriting/Pages/Decision/components/Benefit/_hooks/useGetCurrentContractTypeProductDicts.ts';
import CoverageItem from './components/CoverageItem/index';
import useGetWaiveListByCoreCode from 'opus/NewBusiness/ManualUnderwriting/Pages/Decision/components/Benefit/_hooks/useGetWaiveListByCoreCode';
import useGetRopListByCoreCode from 'opus/NewBusiness/ManualUnderwriting/Pages/Decision/components/Benefit/_hooks/useGetRopListByCoreCode';
import useGetRopPlanOptionList from '../../_hooks/useGetRopPlanOptionList';
