...
import useGetPaymentOptionDicts from 'opus/NewBusiness/ManualUnderwriting/Pages/Payment/_hooks/useGetPaymentOptionDicts';
...
const FormItem = ({ isShow, layout, form, editable, field, config, showOnly }: any) => {
  ...
  const {
    ...
    id,
    paymentOption,
  } = form.getFieldsValue(['id', 'payType', 'paymentOption']);
