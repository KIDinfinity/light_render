...
import { fieldConfig } from './Masterpolicynumber.config';

export { fieldConfig } from './Masterpolicynumber.config';
...
const Masterpolicynumber = ({ field, form, editable, layout, isShow, config,showOnly }: any) => (
  <Authority>
      <FormItem field={field} isShow={isShow} layout={layout} form={form} editable={editable} config={config} showOnly={showOnly}/>
  </Authority>
);

Masterpolicynumber.displayName = 'masterPolicyNumber';

export default Masterpolicynumber;
