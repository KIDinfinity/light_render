...
import { fieldConfig } from './Bankcity.config';

export { fieldConfig } from './Bankcity.config';
...
const Bankcity = ({ field, form, editable, layout, isShow, config }: any) => (
  <Authority>
    <FormItem
      field={field}
      isShow={isShow}
...
Bankcity.displayName = 'bankCity';

export default Bankcity;
