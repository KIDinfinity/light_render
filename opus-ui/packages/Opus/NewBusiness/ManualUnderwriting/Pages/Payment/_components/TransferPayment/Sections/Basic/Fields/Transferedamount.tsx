...
import { fieldConfig } from './Transferedamount.config';

export { fieldConfig } from './Transferedamount.config';
...
const Transferedamount = ({ form, editable, layout, isShow, config, field }: any) => (
  <Authority>
    <FormItem
      isShow={isShow}
      layout={layout}
...
Transferedamount.displayName = 'transferedAmount';

export default Transferedamount;
