...
import { fieldConfig } from '../../../_config/DistributionChannelField/AgentChannelCode.config';
...
const AgentChannelCode = ({ isShow, layout, form, editable, field, config }: IFiledProps) => {
  const propsConfig = {
    field,
    editable,
    isShow,
...
AgentChannelCode.displayName = 'agentChannelCode';

export default AgentChannelCode;
