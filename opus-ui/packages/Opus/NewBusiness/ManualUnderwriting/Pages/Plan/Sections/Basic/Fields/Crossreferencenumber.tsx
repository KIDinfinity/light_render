...
import { fieldConfig } from './Crossreferencenumber.config';

export { fieldConfig } from './Crossreferencenumber.config';
...
const Crossreferencenumber = ({ field, isShow, layout, form, editable, config }: any) => (
  <Authority>
    <FormItem
      field={field}
      isShow={isShow}
...
Crossreferencenumber.displayName = 'crossReferenceNumber';

export default Crossreferencenumber;
