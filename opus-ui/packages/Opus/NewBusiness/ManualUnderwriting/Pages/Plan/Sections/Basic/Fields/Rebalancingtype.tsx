...
const FormItem = ({ isShow, layout, form, editable, field, config }: any) => {
  ...
  const dicts = useGetHierarchyDicts({
    parentType: 'Dropdown_POL_privateFundFlag',
    parentCode: form.getFieldValue('privateFundFlag'),
    subType: dictTypeCode,
  }).sort((a: { dictName: string }, b: { dictName: string }) =>
    a.dictName.localeCompare(b.dictName)
  );
...
const Rebalancingtype = ({ form, editable, layout, isShow, config }: any) => (
  <Authority>
    <FormItem
      isShow={isShow}
      layout={layout}
