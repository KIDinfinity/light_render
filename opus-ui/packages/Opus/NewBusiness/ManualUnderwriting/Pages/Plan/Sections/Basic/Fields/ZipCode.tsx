...
import { useGetCurrentLevelAddress } from 'opus/NewBusiness/ManualUnderwriting/Pages/Plan/_hooks';
import AddressLevel from 'opus/NewBusiness/ManualUnderwriting/_enum/AddressLevel';
...
const ZipCode = ({ form, editable, layout, isShow, id, config }: any) => {
  return (
    <Authority>
      <FormItem
