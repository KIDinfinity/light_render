...
export default connect(({ [NAMESPACE]: modelnamepsace }: any, { clientId }: any) => ({
  ...
  newCrs: modelnamepsace.entities.clientMap?.[clientId]?.newCrs,
  ...
  Form.create({
    mapPropsToFields(props: any) {
      const { financialInfoData, exchangeRate, newCrs } = props;
      ...
      return formUtils.mapObjectToFields({ ...financialInfoData, ...extraFields, newCrs });
    },
  })(FinancialInfo)
);
