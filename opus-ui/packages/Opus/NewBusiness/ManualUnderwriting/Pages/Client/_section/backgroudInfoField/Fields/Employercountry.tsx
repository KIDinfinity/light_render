...
import { fieldConfig } from './Employercountry.config';

export { fieldConfig } from './Employercountry.config';
...
const Employercountry = ({ form, editable, layout, isShow, id, config }: any) => {
  return (
    <Authority>
      <FormItem
...
Employercountry.displayName = 'employerCountry';
