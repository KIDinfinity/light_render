...
import { fieldConfig } from './UBOShareholder.config';

export { fieldConfig } from './UBOShareholder.config';
...
const UBOShareholder = ({ form, editable, layout, isShow, config }: any) => (
  <Authority>
    <FormItem
      isShow={isShow}
      layout={layout}
...
UBOShareholder.displayName = 'companyLegalForm';

export default UBOShareholder;
