...
import { fieldConfig } from './PAOccupationClassSecondary.config';
export { fieldConfig } from './PAOccupationClassSecondary.config';
...
const PAOccupationClassSecondary = ({
  form,
  editable,
  layout,
  isShow,
...
PAOccupationClassSecondary.displayName = 'paOccupationClassSecondary';

export default PAOccupationClassSecondary;
