...
import { ContactType } from 'opus/NewBusiness/ManualUnderwriting/_enum';
...
const FormItem = ({
  ...
  const contactTypeDicts = useGetContacttypeDicts({
    config,
    fieldConfig,
    contactSeqNum,
    id,
  ...
  const dicts = lodash.filter(contactTypeDicts, (dict) => dict.dictCode === ContactType.Office);
