...
import { fieldConfig } from './Crralertid.config';

export { fieldConfig } from './Crralertid.config';
...
const Crralertid = ({ field, form, editable, layout, isShow, config }: any) => (
  <Authority>
    <FormItem
      field={field}
      isShow={isShow}
...
Crralertid.displayName = 'crrAlertId';

export default Crralertid;
