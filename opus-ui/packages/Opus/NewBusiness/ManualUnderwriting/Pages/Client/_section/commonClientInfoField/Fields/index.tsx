...
import Childrelationshiptype, {
  fieldConfig as childrelationshiptypeConfig,
} from './Childrelationshiptype';
import CompanyRegistrationNumberSeach, {
  fieldConfig as CompanyRegistrationNumberSeachConfig,
} from './CompanyRegistrationNumberSeach';
...
export const localFieldConfigs = [
  ...
  CompanyRegistrationNumberSeachConfig,
];
...
export default {
  ...
  CompanyRegistrationNumberSeach,
};
