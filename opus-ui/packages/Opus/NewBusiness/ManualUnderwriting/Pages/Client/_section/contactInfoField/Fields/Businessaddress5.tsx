...
import { fieldConfig } from './Businessaddress5.config';

export { fieldConfig } from './Businessaddress5.config';
...
const ItemSelectTH = ({
  ...
  const dicts2 = useGetCascadeAdress({ level: 1, form, type: 'business' });
  return (
    <FormItemSelect
      dicts={dicts2}
      dictCode="code"
...
Businessaddress5.displayName = 'businessAddress5';

export default Businessaddress5;
