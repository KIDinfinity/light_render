...
import { fieldConfig } from './Alertid.config';

export { fieldConfig } from './Alertid.config';
...
const Alertid = ({ field, form, editable, layout, isShow, config }: any) => (
  <Authority>
    <FormItem
      field={field}
      isShow={isShow}
