...
import { fieldConfig } from './Usresidenceaddress4.config';

export { fieldConfig } from './Usresidenceaddress4.config';
      ...
      <Col {...layout}>
        <FormItemSelect
          ...
          placeholder={formatMessageApi({
            Label_BIZ_Individual: 'AddressLine4',
          })}
        />
      </Col>
    )
...
const Usresidenceaddress4 = ({ form, editable, layout, isShow, id, config }: any) => {
  return (
    <Authority>
      <FormItem
...
Usresidenceaddress4.displayName = 'usResidenceAddress4';

export default Usresidenceaddress4;
