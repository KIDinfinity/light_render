...
import { fieldConfig } from './Risklevel.config';

export { fieldConfig } from './Risklevel.config';
...
const Risklevel = ({ field, isShow, layout, form, editable, config }: any) => (
  <Authority>
    <FormItem
      field={field}
      isShow={isShow}
...
Risklevel.displayName = 'riskLevel';
