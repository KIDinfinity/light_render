...
import { fieldConfig } from './Residentialaddress5.config';

export { fieldConfig } from './Residentialaddress5.config';
...
const ItemSelectTH = ({
  ...
  const dicts2 = useGetCascadeAdress({ level: 1, form, type: 'residentiala' });
  return (
    <FormItemSelect
      dicts={dicts2}
      dictCode="code"
          ...
          tenant.region({
            [Region.ID]: (
              <FormItemInput
                disabled={
                  !editable ||
                  ((config?.editable || fieldProps.editable) ===
                  Editable.Conditions
                    ? editableConditions
                    : (config?.editable || fieldProps.editable) === Editable.No)
                }
...
Residentialaddress5.displayName = 'residentialAddress5';

export default Residentialaddress5;
