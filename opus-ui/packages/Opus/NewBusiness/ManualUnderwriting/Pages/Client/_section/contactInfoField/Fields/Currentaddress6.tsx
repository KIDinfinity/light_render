...
import { fieldConfig } from './Currentaddress6.config';
import { tenant, Region } from '@/components/Tenant';

export { fieldConfig } from './Currentaddress6.config';
...
const ItemSelectTH = ({
  ...
  const dicts2 = useGetCascadeAdress({ level: 0, form, type: 'current' });
  return (
    <FormItemSelect
      dicts={dicts2}
      dictCode="code"
...
Currentaddress6.displayName = 'currentAddress6';

export default Currentaddress6;
