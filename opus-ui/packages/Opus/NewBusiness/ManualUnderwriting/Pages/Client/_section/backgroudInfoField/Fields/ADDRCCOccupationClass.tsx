...
import { fieldConfig } from './ADDRCCOccupationClass.config';
export { fieldConfig } from './ADDRCCOccupationClass.config';
...
const ADDRCCOccupationClass = ({ form, editable, layout, isShow, id, config, readOnly }: any) => {
  return (
    <Authority>
      <FormItem
...
ADDRCCOccupationClass.displayName = 'addRccOccupationClass';

export default ADDRCCOccupationClass;
