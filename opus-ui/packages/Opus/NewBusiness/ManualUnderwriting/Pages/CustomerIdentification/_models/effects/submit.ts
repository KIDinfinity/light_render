...
import { NAMESPACE as NBNAMESPACE } from 'opus/NewBusiness/ManualUnderwriting/activity.config';

import { getTouchResult } from '@/services/navigatorCaseTouchOperationControllerService';
import MessageModal from 'opus/NewBusiness/ManualUnderwriting/_models/effects/DataHandle/MessageModal';
