...
import useGetDefaultJuvenileAgeRange from 'opus/NewBusiness/ManualUnderwriting/Pages/Client/_hooks/useGetDefaultJuvenileAgeRange';
    ...
    if (
      ...
      return lodash
        ...
        .filter((client: any) => {
          ...
          return (
            lodash.includes(customerRole, CustomerRole.Insured) &&
            lodash.includes(customerRole, CustomerRole.PolicyOwner)
          );
        })
