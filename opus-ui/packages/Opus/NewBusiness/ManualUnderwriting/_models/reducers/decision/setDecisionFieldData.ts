...
const linkCoreCode = ({ planProductConfig, coreCode, extraFields, coverageList, isMain }: any) => {
      ...
      .forEach((fieldItem) => {
        ...
        switch (key) {
          ...
          case 'coreCode':
            ...
            const extraFields = {
              hospitalPlanCode: '', // 修改coreCode时置空
            };
          ...
          case 'facultativeReason':
            lodash.set(
              draftState,
              `modalData.processData.coverageList.[${index}].coverageDecision`,
              {
                ...lodash.get(
                  draftState,
                  `modalData.processData.coverageList.[${index}].coverageDecision`,
