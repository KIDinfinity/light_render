...
import useOccupationField from '../../../../_hooks/useOccupationField';


const fieldConfig = {
  section: 'payorOccupation',
  field: 'otherNatureOfBusiness',
  'field-props': {
    editable: 'N',
    label: {
...
const FormItem = ({ isShow, layout, form, editable, field, config }: any) => {
  ...
  const dicts = useOccupationField({
    form,
    occupationCodeField: 'otherOccupation',
    subTypeCode: 'Dropdown_IND_NatureofBusiness',
    currentField: 'otherNatureOfBusiness',
    reducer: 'savePayorOccupation',
  })
