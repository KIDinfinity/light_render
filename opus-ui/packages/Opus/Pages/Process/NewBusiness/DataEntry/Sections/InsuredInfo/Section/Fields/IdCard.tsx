...
import { VLD_001179, VLD_001181, VLD_001183 } from 'claim/pages/validators/fieldValidators';
...
const FormItem = ({ isShow, layout, form, editable, field, config }: any) => {
  ...
  const payorIdCard = useSelector(
    ({ [NAMESPACE]: modelnamepsace }: any) => modelnamepsace?.processData?.payorInfo?.idCard
  );
  return (
    isShow &&
      ...
      <Col {...layout}>
        <FormItemInput
          ...
          rules={[
            ...
            {
              validator: VLD_001179(payorIdCard),
            },
          ]}
        />
      </Col>
