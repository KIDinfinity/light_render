...
const field = 'docDeliveryMethod';

const DocDeliveryMethod = ({ config, form, editable, layout, isShow }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
...
DocDeliveryMethod.displayName = field;

export default DocDeliveryMethod;
