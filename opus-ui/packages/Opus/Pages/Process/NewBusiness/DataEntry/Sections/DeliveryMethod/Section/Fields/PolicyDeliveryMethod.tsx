...
const field = 'policyDeliveryMethod';

const PolicyDeliveryMethod = ({ config, form, editable, layout, isShow }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
...
PolicyDeliveryMethod.displayName = field;

export default PolicyDeliveryMethod;
