...
const field = 'coAgentProportion';

const CoAgentProportion = ({ config, form, editable, layout, isShow }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
...
CoAgentProportion.displayName = field;

export default CoAgentProportion;
