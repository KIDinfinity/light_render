...
const field = 'pdpaConsent1';

const InsuredPdpaConsent1 = ({ config, form, editable, layout, isShow }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
...
InsuredPdpaConsent1.displayName = field;

export default InsuredPdpaConsent1;
