...
import { VLD_001177 } from 'claim/pages/validators/fieldValidators';
...
const FormItem = ({ isShow, layout, form, editable, field, config }: any) => {
  ...
  const dicts = useGetCascadeAdress({ level: 0, form, type: 'address' });
