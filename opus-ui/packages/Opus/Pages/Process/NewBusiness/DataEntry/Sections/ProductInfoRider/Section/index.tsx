...
const Section = ({ section, form, children, formId, actionComponent }: any) => {
...
const Insured = ({ form, editable, children, sectionId, formId, actionComponent }: any) => {
  return (
    <Section section={sectionId} form={form} formId={formId} actionComponent={actionComponent}>
