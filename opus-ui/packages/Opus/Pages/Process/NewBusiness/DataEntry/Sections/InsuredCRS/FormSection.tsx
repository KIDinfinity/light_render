...
export default connect(({ [NAMESPACE]: modelnamespace }: any) => ({
  data: modelnamespace.processData?.insuredCrs,
  insuredInfo: modelnamespace.processData?.insuredInfo,
}))(
  Form.create<any>({
    ...
    mapPropsToFields(props) {
      const { data, insuredInfo }: any = props;
      const { name, lastName, nationality, idCard, passportNo } = insuredInfo || {};
