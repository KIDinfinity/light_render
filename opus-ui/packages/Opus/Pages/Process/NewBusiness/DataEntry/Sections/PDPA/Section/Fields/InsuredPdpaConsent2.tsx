...
const field = 'pdpaConsent2';

const InsuredPdpaConsent2 = ({ config, form, editable, layout, isShow }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
...
InsuredPdpaConsent2.displayName = field;

export default InsuredPdpaConsent2;
