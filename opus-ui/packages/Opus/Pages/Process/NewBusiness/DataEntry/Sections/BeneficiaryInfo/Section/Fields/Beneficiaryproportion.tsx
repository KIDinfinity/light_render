...
const field = 'beneficiaryproportion';

const Beneficiaryproportion = ({ config, form, editable, layout, isShow }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
...
Beneficiaryproportion.displayName = field;

export default Beneficiaryproportion;
