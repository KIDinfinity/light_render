...
const FormSection = ({ form, section, layoutName, register, children }: any) => {
  ...
  return (
    <div className={styles.followUpTaskSection}>
...
const Section = ({ form, editable, children, layoutName, section, index }: any) => (
  <FormSection section={section} layoutName={layoutName} form={form}>
    {React.Children.map(children, (child: any) =>
      React.cloneElement(child, { form, editable, section, index })
    )}
  </FormSection>
);
