...
import { localFieldConfig } from './PremiumPaymentStatus.config';

export { localFieldConfig } from './PremiumPaymentStatus.config';
...
const PremiumPaymentStatus = ({ isShow, layout, form, editable, section, config }: any) => (
  <Authority>
...
PremiumPaymentStatus.displayName = localFieldConfig.field;
