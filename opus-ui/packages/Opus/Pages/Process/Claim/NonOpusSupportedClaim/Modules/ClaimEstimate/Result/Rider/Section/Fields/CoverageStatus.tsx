...
import { localFieldConfig } from './CoverageStatus.config';

export { localFieldConfig } from './CoverageStatus.config';
...
const CoverageStatus = ({ isShow, layout, form, editable, section, config }: any) => (
  <Authority>
...
CoverageStatus.displayName = localFieldConfig.field;
