  ...
  const nextState = produce(state, (draftState: any) => {
    ...
    const dataMap = {
      [eClaimDecision.approve]: [
        ...
        settlementDecision.PC,
        settlementDecision.PI,
        settlementDecision.PS,
        settlementDecision.PP,
      ],
      [eClaimDecision.deny]: [
        settlementDecision['03'],
        settlementDecision.AD,
        settlementDecision.BD,
        settlementDecision.CC,
        settlementDecision.DT,
        settlementDecision.ER,
        settlementDecision.FC,
        settlementDecision.IC,
        settlementDecision.MR,
        settlementDecision.NA,
        settlementDecision.NC,
        settlementDecision.NE,
        settlementDecision.NP,
        settlementDecision.NS,
        settlementDecision.PV,
        settlementDecision.SV,
      ],
