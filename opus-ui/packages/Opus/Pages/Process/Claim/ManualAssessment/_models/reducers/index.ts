...
import removeLifePayableItem from './removeLifePayableItem';
...
import savePolicyBeneficiaryList from './savePolicyBeneficiaryList';

import saveSerialClaimFlag from './saveSerialClaimFlag';
import saveSerialClaimMap from './saveSerialClaimMap';
import saveSerialClaimTreatmentId from './saveSerialClaimTreatmentId';
...
import firstTreatmentDateAdd from './firstTreatmentDateAdd';
import firstTreatmentDateDelete from './firstTreatmentDateDelete';
...
import benefitTypeUpdate from './benefitTypeUpdate';
...
import addPayeePaymentInformation from './addPayeePaymentInformation';
import deletePayeePaymentInformation from './deletePayeePaymentInformation';
import deletePayeePaymentInformationTemp from './deletePayeePaymentInformationTemp';
import addPayee from './addPayee';
import deletePayee from './deletePayee';
import addBankAccount from './addBankAccount';
import deleteBankAccount from './deleteBankAccount';
import setNameScreeningVisible from './setNameScreeningVisible';
import saveClientInfoList from './saveClientInfoList';
import updatePopupData from './updatePopupData';
import popupDataConfirm from './popupDataConfirm';
import supplementGroupCode from './supplementGroupCode';

import { paymentReducers } from 'process/Payment/_models';
import saveCaseDetail from './saveCaseDetail';
...
export default {
  ...
  saveTaskDetail,
  savePolicyBeneficiaryList,

  saveSerialClaimFlag,
  saveSerialClaimMap,
  saveSerialClaimTreatmentId,
  ...
  firstTreatmentDateAdd,
  firstTreatmentDateDelete,
  ...
  savePayeeInfo,
  savePayeeDicts,
  addPayeePaymentInformation,
  deletePayeePaymentInformation,
  deletePayeePaymentInformationTemp,
  addPayee,
  deletePayee,
  addBankAccount,
  deleteBankAccount,
  setNameScreeningVisible,
  saveClientInfoList,
  supplementGroupCode,

  saveCaseDetail,
  removeLifePayableItem,
  updatePopupData,
  popupDataConfirm,
  ...paymentReducers,
