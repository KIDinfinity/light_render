...
export const FormItem = ({ isShow, layout, form, editable, field, config }: any) => {
  ...
  const coreProductCode = formUtils.queryValue(basic?.productCode) || '';

  const policyNoList = useMemo(() => {
    return getPolicyForBenefitItemList({
      policyNo,
      listPolicy,
      benefitTypeCode,
      coverageKey,
  ...
  }, [policyNo, listPolicy, benefitTypeCode, coverageKey, coreProductCode]);
