...
export const FormItem = ({
  ...
  const Rules = {
    ...
    dischargeDateLaterAdmissionDate:
      Validator.dischargeDateLaterAdmissionDate(dateOfAdmissionValue),
  };
...
DateOfDischargeEntry.displayName = 'DateOfDischargeEntry';

export default DateOfDischargeEntry;
