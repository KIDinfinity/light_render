...
const FormSection = ({ form, section, layoutName, children, formId }: any) => {
...
const Section = ({ form, editable, children, layoutName, section, id }: any) => (
  <FormSection section={section} layoutName={layoutName} form={form} formId={`${section}_${id}`}>
