...
export const FormItem = ({ isShow, layout, form, field, config, dictCode }: any) => {
  ...
  const visibleConditions =
    ...
    form.getFieldValue('isAdjustment') === 'Y' &&
    !form.getFieldValue('isOrigin');
...
const CriticalIllness = ({ field, config, isShow, layout, form, dictCode }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
