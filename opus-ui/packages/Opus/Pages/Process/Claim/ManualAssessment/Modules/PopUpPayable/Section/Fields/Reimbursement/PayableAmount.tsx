...
const TreatmentPayableAmount = ({ field, config, isShow, layout, form, editable, data }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
...
TreatmentPayableAmount.displayName = 'PayableAmount';

export default TreatmentPayableAmount;
