...
const TransferClassification = ({ field, config, form, editable, layout, isShow }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
...
TransferClassification.displayName = 'transferAccount';

export default TransferClassification;
