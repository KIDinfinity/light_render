...
const PolicyInsured = ({ field, config, form, editable, layout, isShow }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
...
PolicyInsured.displayName = 'policyInsured';

export default PolicyInsured;
