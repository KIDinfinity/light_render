...
export const localFieldConfig = {
  ...
  'field-props': {
    ...
    label: {
      ...
      dictCode: 'BeneficiaryPercentage',
    },
    maxLength: 3,
    required: 'Y',
    visible: 'Y',
...
const BeneficiaryPercentage = ({ field, config, form, editable, layout, isShow }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
...
BeneficiaryPercentage.displayName = 'beneficiaryPercentage';

export default BeneficiaryPercentage;
