...
const FormItem = ({ isShow, layout, form, editable, config, field }: any) => {
  ...
  const isProcedureCodeOTHS = Rule(fieldProps['editable-condition'], form, 'opusClaimDataCapture');
...
const ProcedureDescription = ({ field, config, form, editable, layout, isShow }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
