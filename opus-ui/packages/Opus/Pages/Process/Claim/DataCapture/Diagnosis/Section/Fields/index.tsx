...
import ExistingCancerDiagnosis, {
  localFieldConfig as ExistingCancerDiagnosisConfig,
} from './ExistingCancerDiagnosis';
import CancerDiseaseStates, {
  localFieldConfig as CancerDiseaseStatesConfig,
} from './CancerDiseaseStates';
import CancerBiologicalBehavior, {
  localFieldConfig as CancerBiologicalBehaviorConfig,
} from './CancerBiologicalBehavior';
export const localFieldConfigs = [
  ...
  CancerDiseaseStatesConfig,
  CancerBiologicalBehaviorConfig,
];
