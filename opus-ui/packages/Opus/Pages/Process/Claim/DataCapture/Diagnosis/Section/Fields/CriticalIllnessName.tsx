...
const FormItem = ({ isShow, layout, form, editable, config, field }: any) => {
  ...
  const isCINameEditable = Rule(fieldProps['editable-condition'], form, 'opusClaimDataCapture');
  const isCINameRequired = Rule(fieldProps['required-condition'], form, 'opusClaimDataCapture');
