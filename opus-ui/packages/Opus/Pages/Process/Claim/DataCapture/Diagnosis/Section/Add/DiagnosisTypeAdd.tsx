...
import { isExistPrimary } from 'opus/Pages/Process/Claim/DataCapture/_models/functions'
...
const FormItem = ({ isShow, layout, form, editable, field, config, incidentId }: any) => {
  ...
  const diagnosisListMap = useSelector(({ opusClaimDataCapture }: any) => opusClaimDataCapture.claimEntities.diagnosisListMap)
