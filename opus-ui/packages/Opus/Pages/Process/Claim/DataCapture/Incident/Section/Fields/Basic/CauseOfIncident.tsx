...
export const FormItem = ({
  ...
  const temp =
    lodash
      ...
      .value() || '';
  const Rules = {
    VLD_000765: Validator.VLD_000765({ diagnosis, diagnosisListId: diagnosisListId || [] }),
    VLD_001138: Validator.VLD_001138({ diagnosis, diagnosisListId: diagnosisListId || [] }),
  };
