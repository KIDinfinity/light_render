...
import ContactType, { localFieldConfig as ContactTypeConfig } from './Fields/ContactType';
...
const Section = ({ section, form, children, formId }: any) => {
  ...
  return (
    <div>
      <FormRegister form={form} formId={formId || 'payee'}>
...
const Payee = ({ form, editable, children, formId }: any) => (
  <Section section="payee" form={form} formId={formId}>
