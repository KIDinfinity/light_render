...
import { localFieldConfig } from './OpusCaseNo.config';

export { localFieldConfig } from './OpusCaseNo.config';
...
export const FormItem = ({ isShow, layout, form, editable, field, config }: any) => {
  ...
  const requiredConditions = RuleByData(config?.['required-condition'], businessData) && !form.getFieldValue('hostClaimNo');
...
const OpusCaseNo = ({ field, config, isShow, layout, form, editable }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
...
OpusCaseNo.displayName = localFieldConfig.field;

export default OpusCaseNo;
