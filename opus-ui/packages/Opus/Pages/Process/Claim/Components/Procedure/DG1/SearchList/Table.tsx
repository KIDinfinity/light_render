...
function List({
  ...
  const {allList,drugsListStore,page} =useSelector(({ opusClaimDataCapture }: any) => opusClaimDataCapture.DrugsDetail)
  const handleChecked = (item: any)=>{//增加/删除store中的某条数据
    dispatch({
      type:'opusClaimDataCapture/updateDrugsListStore',
      payload: {
...
export default connect(({ loading }: any) => ({
  loading: loading.effects['opusClaimDataCapture/showDrugsDetailList']
}))(List);
