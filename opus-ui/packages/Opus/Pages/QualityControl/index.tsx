...
const Main = () => {
  ...
  const configRequest = tenant.isJP()
    ? {
        modalTabs:
    ...
    : { myTaskTab, modalTabs: ModalTabs.opusQualityControl };

  const modalTabs = configRequest.modalTabs;

  const { resultConfigs, searchConfigs, categoryCode, configName } =
    getConfigurationItem(configRequest);
