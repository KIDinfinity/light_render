...
import type { FormComponentProps } from 'plugins/ant-design/lib/form';
...
interface ReassignModalProps extends FormComponentProps<any> {
  resultConfigs: any;
...
export default connect<any, any, any, any>(({}: any) => ({}))(
  Form.create({})(({ form, resultConfigs, user, visible, onCancel, onOk }: ReassignModalProps) => {
      ...
      return [
        {
          ...
          placeholder: selected.length
            ...
            : formatMessageApi({ Label_COM_Opus: 'pleaseSelectCaseFirst' }),
    ...
    const getReassignableOptions = async (selectList: any[]) => {
          ...
          <div className={styles.content}>
            ...
            <div className={styles.info}>
              <div className={styles.title}>
                {user
                  ? `${formatMessageApi({
                      Label_COM_Opus: ALL_CASES_FOR,
                    })}} ${userName} (${formatMessageApi({
                      Label_COM_Opus: TO_DO,
                    })}: ${todoCaseCount}, ${formatMessageApi({
                      Label_COM_Opus: PENDING,
                    })}: ${pendingCaseCount})`
            ...
            <TaskTable
              ...
              hasRowSelect
              selectedRowKeys={selected.map((item: any) => item.taskId)}
