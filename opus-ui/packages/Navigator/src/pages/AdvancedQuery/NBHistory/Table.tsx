...
class AdvancedQueryOfNBHistory extends Component<any> {
  handleSearch = async (values: any = {}, e: any) => {
    const { dispatch, getTaskDetail, setCaseDetail, saveStateOfSearch, setTaskId, setProcessInstanceId } = this.props;
      ...
      >
        ...
        <AttachSaleSubChannelData {...workspaceNBHistory?.list}>
          <Table
            ...
            columns={historyColumns(stateOfSearch.orders, nbHistoryConfig?.resultField, {
