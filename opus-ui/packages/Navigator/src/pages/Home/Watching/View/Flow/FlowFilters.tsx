...
@connect(({ loading, homeTaskFlowFilter, workspaceUser, theme, user }: any) => ({
...
class TaskFlowFilters extends Component<IComponentProps> {
  ...
  render() {
    const { form, assigneeList, userOrganization, loading, activeTheme, userId } = this.props;
      ...
      <div className={styles.filtersPosition}>
        <div className={styles.filtersBg}>
          <div className={styles.filterItem}>
            {formatMessageApi({ Label_BIZ_Claim: 'app.navigator.index.mode.flow.advanced-search' })}
          </div>
          <div className={styles.filterItem}>
            <Hotkey id="group" />
              ...
              <Form.Item
                label={
                  <ErrorTooltip
                    ...
                    formName="assignee"
                    title={formatMessageApi({
                      Label_BIZ_Claim: 'app.navigator.index.mode.flow.assign',
                    })}
                  />
                }
              >
          ...
          <div
            ...
            style={{ flex: '0 0 150px', borderTopRightRadius: '18px' }}
          >
            {loading ? (
