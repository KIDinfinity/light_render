...
export default ({ orders, resultField, filterParams, filterObj, handleTitleChange }: IProps) => {
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: 'assignBy',
      defaultSortOrder: lodash.get(orders, 'assignee.sortOrder'),
      render: (text: any, item: any) => lodash.get(item, 'assignByName') || lodash.get(item, 'assignBy')|| '-',
    },
    {
      ...
      defaultSortOrder: lodash.get(orders, 'assignee.sortOrder'),
      render: (text: any, item: any) => lodash.get(item, 'assignFromName') || lodash.get(item, 'assignFrom')|| '-',
    },
    {
