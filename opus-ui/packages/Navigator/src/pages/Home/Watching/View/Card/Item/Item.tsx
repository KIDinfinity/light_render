...
const Item = ({
  ...
  const { caskIndex } = useSelector((state: any) => ({
    caskIndex: state.task.caskIndex,
  }));
  ...
  return (
    <div
      key={item.procInstId}
      onClick={onClick}
      className={classnames('item-wrap', styles.homePageCard)}
    >
      <div
            ...
            <div className={styles.right}>
              <div className={styles.rightTop}>
                ...
                <div className={styles.activityName}>
                  <Ellipsis length={20}>
                    {formatMessageApi({ activity: item.activityKey, caseCategory: item.caseCategory })}
                  </Ellipsis>
                </div>
