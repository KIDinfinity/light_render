...
export default function Monitor() {
  ...
  const [width, setWidth] = useState(document.body.offsetWidth - 44 - 40 - 40 - 20 - 20);
  ...
  const resizeRender = () => {
    setWidth(document.body.offsetWidth - 44 - 40 - 40 - 20 - 20);
              ...
              >
                <div
                  className={classnames(
                    styles.sectionBox,
                    isExpanded ? styles.expandedSection : styles.retractedSection
                  )}
                  ref={(ref) => {
                    if (!ref) {
                      return;
  ...
  return <div className={classnames(styles.content, 'monitorBox')}>{renderGrid}</div>;
}
