...
const ActionGroup = {
  ...
  [Group.Button]: {
    ...
    [Action.qcPass]: Action.qcPass,
    [Action.qcFail]: Action.qcFail,
  },
  [Group.Information]: {
  ...
  [Group.Envoy]: {
    ...
    [Action.SystemAutoWakeUp]: Action.SystemAutoWakeUp,
    [Action.SystemIssuedPending]: Action.SystemIssuedPending,
    [Action.SystemOverduePending]: Action.SystemOverduePending,
    [Action.SystemWaivedPending]: Action.SystemWaivedPending,
  },
};
