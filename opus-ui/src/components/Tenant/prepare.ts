...
moment.defineLocale('hk', { parentLocale: 'en-gb' });
...
moment.defineLocale('vn', { parentLocale: 'en-gb' });
...
moment.defineLocale('my', { parentLocale: 'en-gb' });
...
moment.defineLocale('th', { parentLocale: 'en-gb' });
