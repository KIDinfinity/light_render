...
import { ReactComponent as TriangleIcon } from 'claim/assets/triangle.svg';
...
export default class ErrorTooltip extends React.Component<IProps, IState> {
  ...
  shouldComponentUpdate(nextProps: any, nextState: any) {
    ...
    return (
      ...
      !lodash.isEqual(nextEmphasized, emphasized)
    );
  }
    ...
    return (
      <div className={classNames(styles.ErrorTooltip, 'errorTooltipWrapper')}>
        <span onMouseEnter={this.onMouseEnterFn} onMouseLeave={this.onMouseLeaveFn}>
          ...
          {emphasized && <Icon className={styles.emphasized} component={TriangleIcon} />}
          {reminder && (
            <Tooltip
              getPopupContainer={this.getPopupContainer}
              arrowPointAtCenter
        ...
        <Label
          ...
          style={style}
          disabled={disabled}
          ignoreLabelUpper={ignoreLabelUpper}
        />
        {reload && (
          <Icon
            type="sync"
