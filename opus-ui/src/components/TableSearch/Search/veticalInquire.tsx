...
class Search extends PureComponent {
  ...
  render() {
    const { form, children, handleSearch, inquireMode, loading, isShowExport } = this.props;

    const { expand, docSize } = this.state;
    // 显示展开按钮：
    // 1、搜索控件数量大于1；
    // 2、有simple配置的控件。
    ...
    return (
      <div className={styles.search}>
        <div
          className={classnames(styles.form, 'guidance-advanced-search-vetical-form')}
          style={{ height: docSize > 830 ? 415 : 'calc(100vh - 410px)' }}
        >
