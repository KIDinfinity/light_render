...
export async function findAssigneeDropdownList(params?: any, option?: any): Promise<any> {
  return request(`/api/uc/userGeneralInfo/findAssigneeDropdownList?${stringify(params)}`, {
    ...option,
  });
}
