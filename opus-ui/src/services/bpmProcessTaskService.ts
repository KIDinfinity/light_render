...
export async function getTaskByBusinessNoV2(params?: any, option?: any): Promise<any> {
  return request(`/api/bpm/task/getTaskByBusinessNoV2?${stringify(params)}`, {
    ...option,
    method: 'GET',
  });
}

export async function getTaskByCaseNo(params?: any, option?: any): Promise<any> {
  return request(`/api/bpm/task/getTaskByCaseNo`, {
    ...option,
    body: params,
    method: 'POST',
  });
...
export async function getAutoActivityValueByClaimNo(params?: any, option?: any): Promise<any> {
  return request(`/api/bpm/task/getAutoActivityValueByClaimNo?${stringify(params)}`, {
    ...option,
    method: 'GET',
  });
}
...
export default {
  ...
  validateSubmission,
  batchAssignTaskV2,
  getTaskByBusinessNoV2,
  getTaskByCaseNo,
  getAutoActivityValueByClaimNo,
};
