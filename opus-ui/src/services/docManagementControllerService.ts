...
export async function updateDocInfoV2(params?: any, option?: any): Promise<any> {
  return request('/api/doc/management/v2/updateDocInfo', {
    ...option,
    method: 'POST',
    body: params,
  });
...
export async function voidOrUnVoidDoc(params?: any, option?: any): Promise<any> {
  return request('/api/doc/management/v2/voidOrUnVoidDoc', {
    ...option,
    method: 'POST',
    body: params,
  });
...
export async function getBusinessProcessInfo(params?: any, option?: any): Promise<any> {
  return request(`/api/doc/management/v2/getBusinessProcessInfo`, {
    ...option,
    method: 'POST',
    body: params,
  });
