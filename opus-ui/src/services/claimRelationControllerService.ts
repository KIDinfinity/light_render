...
export async function getJpRelatedTreatmentMap(params?: any, option?: any): Promise<any> {
  return request('/api/claim/relation/getJpRelatedTreatmentMap', {
    ...option,
    method: 'POST',
    body: params,
  });
