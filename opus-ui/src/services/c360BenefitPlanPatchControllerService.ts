...
export async function requestAgentInfoForUI(params?: any, option?: any): Promise<any> {
  return request('/api/c360/agentInfo/requestAgentInfoForUI', {
    ...option,
    method: 'POST',
    body: params,
  });
