...
export async function viewByInquiryBusinessNo(params?: any, option?: any): Promise<any> {
  return request('/api/doc/info/viewByInquiryBusinessNo', {
    ...option,
    method: 'POST',
    body: params,
  });
...
export async function viewByCaseNo(params?: any, option?: any): Promise<any> {
  return request('/api/doc/info/viewByCaseNo', {
    ...option,
    method: 'POST',
    body: params,
  });
