...
export async function getInformationGroups(params?: any, option?: any): Promise<any> {
  return request('/api/bpm/info/getInformationGroups', {
    ...option,
    method: 'POST',
    body: params,
  });
...
export async function getCategoryReasons(params?: any, option?: any): Promise<any> {
  return request('/api/navigator/cases/info/getCategoryReasonV2', {
    ...option,
    method: 'POST',
    body: params,
  });
