...
export async function getCategoryPermission(params?: any, option?: any): Promise<any> {
  return request('/api/rbac2/permission/categoryPermissionCheck', {
    ...option,
    method: 'POST',
    body: params,
  });
...
export async function getActivityPermissionLimit(params?: any, option?: any): Promise<any> {
  return request('/api/rbac2/permissionLimit/getActivityPermissionLimit', {
    ...option,
    method: 'POST',
    body: params,
  });
