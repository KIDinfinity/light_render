...
export async function refreshBankInfo(params?: any, option?: any): Promise<any> {
  return request(`/api/nb/proposal/refreshBankInfo?${stringify(params)}`, {
    ...option,
    method: 'POST',
  });
}

export async function confirmRefund(params?: any, option?: any): Promise<any> {
  return request('/api/nb/proposal/refundConfirm', {
    ...option,
    method: 'POST',
    body: params,
  });
...
export async function dedupCheckAndenquiryCorporate(params?: any, option?: any): Promise<any> {
  return request('/api/nb/proposal/dedupCheckAndenquiryCorporate', {
    ...option,
    method: 'POST',
    body: params,
  });
