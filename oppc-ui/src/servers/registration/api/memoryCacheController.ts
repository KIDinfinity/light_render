...
/** 此处后端没有提供注释 POST /api/null/memoryCache/clearCacheList */
export async function clearCacheList(
  body: API.CacheableOperationVO[],
  options?: { [key: string]: any },
) {
  return request<API.ResultVOVoid>('/api/null/memoryCache/clearCacheList', {
    method: 'POST',
    headers: {
...
/** 此处后端没有提供注释 POST /api/null/memoryCache/disableAllCacheName */
export async function disableAllCacheName(
  body: API.CacheableOperationVO,
  options?: { [key: string]: any },
) {
  return request<API.ResultVOVoid>(
    '/api/null/memoryCache/disableAllCacheName',
    {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
...
/** 此处后端没有提供注释 POST /api/null/memoryCache/disableCacheName */
export async function disableCacheName(
  body: API.CacheableOperationVO,
  options?: { [key: string]: any },
) {
  return request<API.ResultVOVoid>('/api/null/memoryCache/disableCacheName', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** 此处后端没有提供注释 POST /api/null/memoryCache/enableAllCacheName */
export async function enableAllCacheName(
  body: API.CacheableOperationVO,
  options?: { [key: string]: any },
) {
  return request<API.ResultVOVoid>('/api/null/memoryCache/enableAllCacheName', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** 此处后端没有提供注释 POST /api/null/memoryCache/enableCacheName */
export async function enableCacheName(
  body: API.CacheableOperationVO,
  options?: { [key: string]: any },
) {
  return request<API.ResultVOVoid>('/api/null/memoryCache/enableCacheName', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** 此处后端没有提供注释 POST /api/null/memoryCache/getAllMemoryCache */
export async function getAllMemoryCache(
  body: API.CacheableOperationVO,
  options?: { [key: string]: any },
) {
  return request<API.ResultVO>('/api/null/memoryCache/getAllMemoryCache', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** 此处后端没有提供注释 POST /api/null/memoryCache/getCacheNames */
export async function getCacheNames(
  body: API.CacheableOperationVO,
  options?: { [key: string]: any },
) {
  return request<API.ResultVO>('/api/null/memoryCache/getCacheNames', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** 此处后端没有提供注释 POST /api/null/memoryCache/getDisableCacheNames */
export async function getDisableCacheNames(
  body: API.CacheableOperationVO,
  options?: { [key: string]: any },
) {
  return request<API.ResultVO>('/api/null/memoryCache/getDisableCacheNames', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** 此处后端没有提供注释 POST /api/null/memoryCache/queryCache */
export async function queryCache(
  body: API.CacheableOperationVO,
  options?: { [key: string]: any },
) {
  return request<API.ResultVO>('/api/null/memoryCache/queryCache', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** 此处后端没有提供注释 POST /api/null/memoryCache/queryCacheValue */
export async function queryCacheValue(
  body: API.CacheableOperationVO,
  options?: { [key: string]: any },
) {
  return request<API.ResultVO>('/api/null/memoryCache/queryCacheValue', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** 此处后端没有提供注释 POST /api/null/memoryCache/removeKey */
export async function removeKey(
  body: API.CacheableOperationVO,
  options?: { [key: string]: any },
) {
  return request<API.ResultVOVoid>('/api/null/memoryCache/removeKey', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
