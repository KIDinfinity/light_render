...
/** 此处后端没有提供注释 POST /api/rbac2/memoryCache/clearCacheList */
export async function clearCacheList(
  body: API.CacheableOperationVO[],
  options?: { [key: string]: any },
) {
  return request<API.ResultVOVoid>('/api/rbac2/memoryCache/clearCacheList', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** 此处后端没有提供注释 POST /api/rbac2/memoryCache/disableAllCacheName */
export async function disableAllCacheName(
  body: API.CacheableOperationVO,
  options?: { [key: string]: any },
) {
  return request<API.ResultVOVoid>(
    '/api/rbac2/memoryCache/disableAllCacheName',
    {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
...
/** 此处后端没有提供注释 POST /api/rbac2/memoryCache/disableCacheName */
export async function disableCacheName(
  body: API.CacheableOperationVO,
  options?: { [key: string]: any },
) {
  return request<API.ResultVOVoid>('/api/rbac2/memoryCache/disableCacheName', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** 此处后端没有提供注释 POST /api/rbac2/memoryCache/enableAllCacheName */
export async function enableAllCacheName(
  body: API.CacheableOperationVO,
  options?: { [key: string]: any },
) {
  return request<API.ResultVOVoid>(
    '/api/rbac2/memoryCache/enableAllCacheName',
    {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
...
/** 此处后端没有提供注释 POST /api/rbac2/memoryCache/enableCacheName */
export async function enableCacheName(
  body: API.CacheableOperationVO,
  options?: { [key: string]: any },
) {
  return request<API.ResultVOVoid>('/api/rbac2/memoryCache/enableCacheName', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** 此处后端没有提供注释 POST /api/rbac2/memoryCache/getAllMemoryCache */
export async function getAllMemoryCache(
  body: API.CacheableOperationVO,
  options?: { [key: string]: any },
) {
  return request<API.ResultVO>('/api/rbac2/memoryCache/getAllMemoryCache', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** 此处后端没有提供注释 POST /api/rbac2/memoryCache/getCacheNames */
export async function getCacheNames(
  body: API.CacheableOperationVO,
  options?: { [key: string]: any },
) {
  return request<API.ResultVO>('/api/rbac2/memoryCache/getCacheNames', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** 此处后端没有提供注释 POST /api/rbac2/memoryCache/getDisableCacheNames */
export async function getDisableCacheNames(
  body: API.CacheableOperationVO,
  options?: { [key: string]: any },
) {
  return request<API.ResultVO>('/api/rbac2/memoryCache/getDisableCacheNames', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** 此处后端没有提供注释 POST /api/rbac2/memoryCache/queryCache */
export async function queryCache(
  body: API.CacheableOperationVO,
  options?: { [key: string]: any },
) {
  return request<API.ResultVO>('/api/rbac2/memoryCache/queryCache', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** 此处后端没有提供注释 POST /api/rbac2/memoryCache/queryCacheValue */
export async function queryCacheValue(
  body: API.CacheableOperationVO,
  options?: { [key: string]: any },
) {
  return request<API.ResultVO>('/api/rbac2/memoryCache/queryCacheValue', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** 此处后端没有提供注释 POST /api/rbac2/memoryCache/removeKey */
export async function removeKey(
  body: API.CacheableOperationVO,
  options?: { [key: string]: any },
) {
  return request<API.ResultVOVoid>('/api/rbac2/memoryCache/removeKey', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
