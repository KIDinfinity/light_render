...
import * as Plugin_0 from '/Users/226838/Documents/company/oppc-ui/src/app.ts';
  ...
  return [
    {
      ...
      path: process.env.NODE_ENV === 'production' ? void 0 : '/Users/226838/Documents/company/oppc-ui/src/app.ts',
    },
    {
      apply: Plugin_1,
