...
import saveAllPermissionInfo from './saveAllPermissionInfo';
import saveCacheAllRoles from './saveCacheAllRoles';
import saveUserGroupList from './saveUserGroupList';
...
export default (state: any, action: any) => {
  ...
  if (!lodash.isEmpty(userGroupList)) {
    newState = saveUserGroupList(newState, {
  ...
  if (!lodash.isEmpty(allPermissionInfo)) {
    newState = saveAllPermissionInfo(newState, {
  ...
  if (!lodash.isEmpty(allRoleLists)) {
    newState = saveCacheAllRoles(newState, {
