...
const localConfig = {
  configs: [localSectionConfig, ...BenefitTypeConfig, ...BenefitItemConfig],
  remote: true, // 远程配置来源于本地配置，当远程配置同步后，改remote为true
};

const FormSection = ({ section, form, children, register }: any) => {
...
const Section = ({ form, editable, children, section, register = true }: any) => (
  <FormSection section={section} form={form} register={register}>
...
export { BenefitTypeFields, BenefitItemFields, SectionColumns, localConfig };
