...
import { useCalcRequireByConditions } from 'process/NewBusiness/ManualUnderwriting/Pages/Plan/_hooks';
...
const Sourcefund = ({ form, editable, config, layout, isShow, fieldType }: any) => (
  <Authority>
    <FormItem
