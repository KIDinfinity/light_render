  ...
  return (
    <FormRegister form={form} formId={formId}>
      <Form layout="vertical">
        <FixedFieldLayout config={config} form={form} layoutName={layoutName}>{children}</FixedFieldLayout>
      </Form>
    </FormRegister>
  );
};

const DPRemarkSection = ({ form, editable, children, formId,layoutName }: any) => (
  <Section section="PostponeDeclineRemark-Field" form={form} layoutName={layoutName} formId={formId}>
