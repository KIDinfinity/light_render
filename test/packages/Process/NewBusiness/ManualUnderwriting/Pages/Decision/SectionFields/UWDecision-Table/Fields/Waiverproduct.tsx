...
import useGenerateWaiveOptionDict from 'decision/components/Benefit/Edit/_hooks/useGenerateWaiveOptionDict';
import useJudgeWaiveProductEditable from 'decision/components/Benefit/Edit/_hooks/useJudgeWaiveProductEditable';
...
const FormItem = ({ isShow, layout, form, editable, field, config, coreCode, disabled }: any) => {
  ...
  const visibleConditions = useJudgeWaiveProductDisplay('edit');
