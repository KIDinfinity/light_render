...
import useFilterDictsByPreDefineDecisionAndPolicyStatus from 'process/NewBusiness/ManualUnderwriting/Pages/Decision/_hooks/useFilterDictsByPreDefineDecisionAndPolicyStatus';
import { NAMESPACE } from 'process/NewBusiness/ManualUnderwriting/activity.config';
import useHandlePolicyReasonChangeCallback from 'process/NewBusiness/ManualUnderwriting/Pages/Decision/_hooks/useHandlePolicyReasonChangeCallback';
...
const FormItem = ({ isShow, layout, form, editable, field, config }: any) => {
  ...
  let allReasonConfigList = useSelector(
    ({ [NAMESPACE]: modelnamepsace }: any) => modelnamepsace.allReasonConfigList,
    shallowEqual
  );
  const preDefineDecision = useGetPreDefineDecision();
  allReasonConfigList = useFilterDictsByPreDefineDecisionAndPolicyStatus({ allReasonConfigList });
