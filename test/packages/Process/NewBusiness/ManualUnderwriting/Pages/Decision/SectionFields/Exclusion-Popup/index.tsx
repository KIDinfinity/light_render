...
const FormSection = ({ section, form, layoutName, children, register, formId }: any) => {
...
const Exclusionpopup = ({ form, editable, children, formId }: any) => (
  <Section section="Exclusion-Popup" form={form} editable={editable} formId={formId}>
    {React.Children.map(children, (child: any) =>
