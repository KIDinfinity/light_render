...
const FormItem = ({ isShow, editable, field, config, layout, form, labelType }: any) => {
...
const ExclusionReason = ({ field, config, form, editable, isShow, layout, labelType }: any) => {
  return (
    <Authority>
      <FormItem
        field={field}
