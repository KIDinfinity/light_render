...
import useGetLoadingFilterDicts from 'process/NewBusiness/ManualUnderwriting/Pages/Decision/_hooks/useGetLoadingFilterDicts.ts';
...
const Extramortality = ({ field, config,
  form,
  editable,
    layout,
  isShow,
