...
import useGetDecisionData from 'process/NewBusiness/ManualUnderwriting/Pages/Decision/_hooks/useGetDecisionData.ts';
...
import useCalculateCoverageTotalSpan from 'process/NewBusiness/ManualUnderwriting/Pages/Decision/components/Benefit/_hooks/useCalculateCoverageTotalSpan.ts';
import useCalculateCoverageSpanBefore from './_hooks/useCalculateCoverageSpanBefore';
