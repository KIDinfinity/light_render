...
import { fieldConfig } from '../../../_config/PolicyReplacementTableField/Insurername.config';
...
const Insurername = ({ isShow, layout, form, editable, field, config }: IFiledProps) => {
...
Insurername.displayName = 'insurerName';
