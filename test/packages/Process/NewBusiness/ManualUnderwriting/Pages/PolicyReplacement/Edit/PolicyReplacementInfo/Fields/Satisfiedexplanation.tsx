...
import { fieldConfig } from '../../../_config/PolicyReplacementField/Satisfiedexplanation.config';
...
const Satisfiedexplanation = ({ isShow, layout, form, editable, field, config }: IFiledProps) => {
