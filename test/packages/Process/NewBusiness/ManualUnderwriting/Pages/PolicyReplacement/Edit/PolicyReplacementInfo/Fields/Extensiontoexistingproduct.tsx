...
import { fieldConfig } from '../../../_config/PolicyReplacementField/Extensiontoexistingproduct.config';
...
const Extensiontoexistingproduct = ({ isShow, layout, form, editable, field, config }: IFiledProps) => {
