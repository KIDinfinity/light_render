...
import { fieldConfig } from '../../../_config/PolicyReplacementField/ReinstatablePolicy.config';
...
const ReinstatablePolicy = ({ isShow, layout, form, editable, field, config }: IFiledProps) => {
