...
import { fieldConfig } from '../../../_config/PolicyReplacementTableField/Otherpolicytype.config';
...
const Otherpolicytype = ({ isShow, layout, form, editable, field, config }: IFiledProps) => {
