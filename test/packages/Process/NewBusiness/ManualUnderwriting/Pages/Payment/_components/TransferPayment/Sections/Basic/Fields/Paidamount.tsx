...
import { fieldConfig } from './Paidamount.config';

export { fieldConfig } from './Paidamount.config';
...
const Paidamount = ({ form, editable, layout, isShow, config, field }: any) => (
  <Authority>
    <FormItem
      isShow={isShow}
      layout={layout}
...
Paidamount.displayName = 'paidAmount';
