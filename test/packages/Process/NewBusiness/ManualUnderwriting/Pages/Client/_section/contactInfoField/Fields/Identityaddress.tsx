...
import { fieldConfig } from './Identityaddress.config';

export { fieldConfig } from './Identityaddress.config';
...
const Identityaddress = ({ field, form, editable, layout, isShow, config }: any) => (
  <Authority>
      <FormItem field={field} isShow={isShow} layout={layout} form={form} editable={editable} config={config}/>
  </Authority>
);

Identityaddress.displayName = 'identityAddress';
