...
import { fieldConfig } from './Currentaddress7.config';

export { fieldConfig } from './Currentaddress7.config';
...
const Currentaddress7 = ({ form, editable, layout, isShow, id, config }: any) => {
  return (
    <Authority>
      <FormItem
...
Currentaddress7.displayName = 'country';

export default Currentaddress7;
