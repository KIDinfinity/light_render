...
import { fieldConfig } from './tsarPI.config';
export { fieldConfig } from './tsarPI.config';
...
const TsarPI = ({ form, editable, layout, isShow, id, config, readOnly }: any) => {
  return (
    <Authority>
      <FormItem
...
TsarPI.displayName = 'tsarPI';

export default TsarPI;
