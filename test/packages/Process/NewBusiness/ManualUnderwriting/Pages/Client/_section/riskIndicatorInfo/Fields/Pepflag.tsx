...
import { fieldConfig } from './Pepflag.config';

export { fieldConfig } from './Pepflag.config';
...
const Pepflag = ({ form, editable, layout, isShow, config }: any) => {
  return (
    <Authority>
      <FormItem
