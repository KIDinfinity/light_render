...
import { fieldConfig } from './Residentialaddress7.config';

export { fieldConfig } from './Residentialaddress7.config';
...
const Residentialaddress7 = ({ form, editable, layout, isShow, id, config }: any) => {
  return (
    <Authority>
      <FormItem
...
Residentialaddress7.displayName = 'residentialAddress7';

export default Residentialaddress7;
