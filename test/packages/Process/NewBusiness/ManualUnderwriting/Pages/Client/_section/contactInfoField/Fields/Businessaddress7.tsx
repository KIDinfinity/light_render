...
import { fieldConfig } from './Businessaddress7.config';

export { fieldConfig } from './Businessaddress7.config';
...
const Businessaddress7 = ({ form, editable, layout, isShow, id, config }: any) => {
  return (
    <Authority>
      <FormItem
...
Businessaddress7.displayName = 'businessAddress7';

export default Businessaddress7;
