...
import { fieldConfig } from './Authorizedrepresentative.config';

export { fieldConfig } from './Authorizedrepresentative.config';
...
const Authorizedrepresentative = ({ form, editable, layout, isShow, id, config }: any) => {
  return (
    <Authority>
      <FormItem
