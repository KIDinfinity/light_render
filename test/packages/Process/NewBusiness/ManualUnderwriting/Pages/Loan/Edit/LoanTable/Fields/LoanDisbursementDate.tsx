...
import { fieldConfig } from '../../../_config/LoanTableField/LoanDisbursementDate.config';
...
LoanDisbursementDate.displayName = 'loanDisbursementDate';

export default LoanDisbursementDate;
