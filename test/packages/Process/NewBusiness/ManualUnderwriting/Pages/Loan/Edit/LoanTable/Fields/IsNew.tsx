...
import { fieldConfig } from '../../../_config/LoanTableField/IsNew.config';
...
const IsNew = ({ isShow, layout, form, editable, field, config, labelType }: IFiledProps) => {
  const propsConfig = {
    field,
    editable,
    isShow,
