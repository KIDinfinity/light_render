...
import { fieldConfig } from '../../../_config/FundField/AutoRebalancingStatus.config';
...
const AutoRebalancingStatus = ({ isShow, layout, form, editable, field, config }: IFiledProps) => {
  const propsConfig = {
    field,
    editable,
    isShow,
