...
import { fieldConfig } from '../../../_config/DistributionChannelField/Paidbypolicyloan.config';
...
const Paidbypolicyloan = ({ isShow, layout, form, editable, field, config }: IFiledProps) => {
  const propsConfig = {
    field,
    editable,
    isShow,
