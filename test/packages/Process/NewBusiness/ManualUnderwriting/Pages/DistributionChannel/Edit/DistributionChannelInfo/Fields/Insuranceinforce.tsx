...
import { fieldConfig } from '../../../_config/DistributionChannelField/Insuranceinforce.config';
...
const Insuranceinforce = ({ isShow, layout, form, editable, field, config }: IFiledProps) => {
  const propsConfig = {
    field,
    editable,
    isShow,
