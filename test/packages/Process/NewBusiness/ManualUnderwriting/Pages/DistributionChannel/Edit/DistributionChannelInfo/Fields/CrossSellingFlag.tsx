...
import { fieldConfig } from '../../../_config/DistributionChannelField/CrossSellingFlag.config';
...
const CrossSellingFlag = ({ isShow, layout, form, editable, field, config }: IFiledProps) => {
  const propsConfig = {
    field,
    editable,
    isShow,
...
CrossSellingFlag.displayName = 'crossSellingFlag';

export default CrossSellingFlag;
