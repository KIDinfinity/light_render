...
import { fieldConfig } from '../../../_config/DistributionChannelField/Agentrelationship.config';
...
const Agentrelationship = ({ isShow, layout, form, editable, field, config }: IFiledProps) => {
  const propsConfig = {
    field,
    editable,
    isShow,
