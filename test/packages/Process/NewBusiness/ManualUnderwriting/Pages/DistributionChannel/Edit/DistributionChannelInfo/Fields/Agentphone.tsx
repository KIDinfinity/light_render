...
import { fieldConfig } from '../../../_config/DistributionChannelField/Agentphone.config';
...
const Agentphone = ({ isShow, layout, form, editable, field, config }: IFiledProps) => {
...
Agentphone.displayName = 'agentPhone';
