...
import { fieldConfig } from '../../../_config/DistributionChannelField/Agentgivenname.config';
...
const Agentgivenname = ({ isShow, layout, form, editable, field, config }: IFiledProps) => {
