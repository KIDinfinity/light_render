...
import { fieldConfig } from '../../../_config/DistributionChannelField/AgentBlacklist.config';
...
const AgentBlacklist = ({ isShow, layout, form, editable, field, config }: IFiledProps) => {
  const propsConfig = {
    field,
    editable,
    isShow,
