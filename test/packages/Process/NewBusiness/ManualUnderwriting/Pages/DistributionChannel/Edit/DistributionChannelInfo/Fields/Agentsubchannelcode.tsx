...
import { fieldConfig } from '../../../_config/DistributionChannelField/Agentsubchannelcode.config';
...
const Agentsubchannelcode = ({ isShow, layout, form, editable, field, config }: IFiledProps) => {
