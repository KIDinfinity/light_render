...
import { fieldConfig } from '../../../_config/DistributionChannelField/Secondaryfwpname.config';
...
const Secondaryfwpname = ({ isShow, layout, form, editable, field, config }: IFiledProps) => {
