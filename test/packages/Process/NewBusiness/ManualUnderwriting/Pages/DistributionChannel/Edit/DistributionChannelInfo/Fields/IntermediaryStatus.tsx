...
import { fieldConfig } from '../../../_config/DistributionChannelField/IntermediaryStatus.config';
...
const IntermediaryStatus = ({ isShow, layout, form, editable, field, config }: IFiledProps) => {
  const propsConfig = {
    field,
    editable,
    isShow,
...
IntermediaryStatus.displayName = 'intermediaryStatus';
