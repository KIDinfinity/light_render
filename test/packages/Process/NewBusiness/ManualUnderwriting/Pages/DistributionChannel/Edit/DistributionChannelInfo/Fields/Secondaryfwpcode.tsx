...
import { fieldConfig } from '../../../_config/DistributionChannelField/Secondaryfwpcode.config';
...
const Secondaryfwpcode = ({ isShow, layout, form, editable, field, config }: IFiledProps) => {
