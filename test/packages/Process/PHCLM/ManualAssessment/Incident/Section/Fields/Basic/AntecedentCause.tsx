...
import { localFieldConfig } from './AntecedentCause.config';

export { localFieldConfig } from './AntecedentCause.config';
...
export const FormItem = ({ isShow, layout, form, editable, field, config, incidentId }: any) => {
  ...
  console.log('claimTypeArray', claimTypeArray);
...
const AntecedentCause = ({ field, config, isShow, layout, form, editable, id }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
...
AntecedentCause.displayName = localFieldConfig.field;

export default AntecedentCause;
