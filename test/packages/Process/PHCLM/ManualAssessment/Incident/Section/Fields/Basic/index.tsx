...
import OtherSignificantCause, {
  localFieldConfig as OtherSignificantCauseConfig,
} from './OtherSignificantCause';
import DateTimeOfDeath, { localFieldConfig as DateTimeOfDeathConfig } from './DateTimeOfDeath';
import ExpressClaim, { localFieldConfig as ExpressClaimConfig } from './ExpressClaim';
