...
const localSectionConfig = {
  ...
  section: 'TODO: Undefined Section',
  'section-props': {
    label: {
      dictTypeCode: 'Label_BIZ_Claim',
      dictCode: 'TODO: Undefined Section Title',
    },
    visible: 'Y',
    'x-layout': {
      // 480px
...
const localConfig = {
  configs: [localSectionConfig, ...FieldConfigs, ...PayableFieldConfigs],
  remote: true,
};
...
export { Fields, SectionTitle, localConfig, PayableFields };
