...
const ServicePayableItem = ({ form, serviceItemPayableId, item, booster, policyBooster, isPayableEditable }: any) => {
...
export default connect(
  ({ formCommonController, [NAMESPACE]: modelnamespace }: any, { serviceItemPayableId, payableId }: any) => ({
    item: modelnamespace.claimEntities?.serviceItemPayableListMap?.[serviceItemPayableId],
    validating: formCommonController.validating,
    isPayableEditable: modelnamespace.claimEntities?.claimPayableListMap?.[payableId]?.isNewPayable || !modelnamespace.claimProcessData?.appeal
  })
)(
  Form.create<any>({
    onFieldsChange(props, changedFields) {
      const { dispatch, serviceItemPayableId, validating, booster, policyBooster, isPayableEditable } = props;
