...
import nonEditable from '../../../../_hooks/nonEditable';
...
import { localFieldConfig } from './PayableAmountBooster.config';

export { localFieldConfig } from './PayableAmountBooster.config';
...
export const FormItem = ({
  ...
  const noneditable = nonEditable(form.getFieldValue('payableId'));
  const editableConditions = Rule(fieldProps['editable-condition'], form, '') && noneditable;
...
PayableAmount.displayName = 'payableAmountBooster';
