...
import AdjustPayableFields, { localFieldConfigs as AdjustPayableFieldConfigs } from './Fields/AdjustPayable';
...
const localConfig = {
  configs: [localSectionConfig, ...PayableFieldConfigs, ...BasicFieldConfigs, ...AddFieldConfigs, ...AdjustPayableFieldConfigs],
  remote: true,
};
...
const FormSection = ({ section, layoutName, form, children, register }: any) => {
...
export { AdjustPayableFields, PayableFields, BasicFields, AddFields, SectionTitle, SectionColumns, localConfig };
