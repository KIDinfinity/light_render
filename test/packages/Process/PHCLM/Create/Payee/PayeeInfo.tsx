...
@connect(
  (
    { dictionaryController, claimEditable, hkProcessController, formCommonController }: any,
    { payeeId }: any
  ) => ({
    ...
    payee: lodash.get(hkProcessController, `claimEntities.payeeListMap.${payeeId}`),
...
@Form.create<IProps>({
  onFieldsChange(props, changedFields) {
    ...
    dispatch({
      type: 'hkProcessController/savePayee',
      payload: {
        changedFields,
        payeeId,
      },
...
class PayeeInfo extends Component<IProps> {
  ...
  handleDelete = () => {
    ...
    dispatch({
      type: 'hkProcessController/removePayeeInfoItem',
      payload: {
        payeeId,
      },
    });
