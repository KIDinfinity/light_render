...
@connect(
  ({ hkProcessController, formCommonController }: any, { incidentId, procedureId }: any) => ({
    procedureItem: hkProcessController.claimEntities.procedureListMap[procedureId],
    incidentDate: hkProcessController.claimEntities.incidentListMap[incidentId].incidentDate,
    dateTimeOfDeath: lodash.get(hkProcessController, 'claimProcessData.insured.dateTimeOfDeath'),
...
@Form.create<IProps>({
  onFieldsChange(props: any, changedFields: any) {
    ...
    if (formUtils.shouldUpdateState(changedFields)) {
      dispatch({
        type: 'hkProcessController/saveProcedureItem',
        payload: {
          changedFields,
          treatmentId,
          procedureId,
...
class ProcedureListItem extends PureComponent<IProps> {
  ...
  handleDelete = () => {
    ...
    dispatch({
      type: 'hkProcessController/removeProcedureItem',
      payload: {
        treatmentId,
        procedureId,
      },
