...
@connect(
  (
    { hkProcessController, dictionaryController, formCommonController }: any,
    { diagnosisId }: any
  ) => ({
    diagnosisItem: hkProcessController.claimEntities.diagnosisListMap[diagnosisId],
...
@Form.create({
  onFieldsChange(props, changedFields) {
    ...
    dispatch({
      type: 'hkProcessController/saveDiagnosisItem',
      payload: {
        changedFields,
        diagnosisId,
      },
...
class DiagnosisListItem extends PureComponent {
  ...
  handleDelete = () => {
    ...
    dispatch({
      type: 'hkProcessController/removeDiagnosisItem',
      payload: {
        incidentId,
        diagnosisId,
      },
