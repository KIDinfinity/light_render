...
import { localFieldConfig } from './UnderlyingCause.config';

export { localFieldConfig } from './UnderlyingCause.config';
...
const UnderlyingCause = ({ field, config, isShow, layout, form, editable, id }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
...
UnderlyingCause.displayName = localFieldConfig.field;

export default UnderlyingCause;
