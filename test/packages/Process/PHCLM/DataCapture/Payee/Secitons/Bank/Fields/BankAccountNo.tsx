...
export const FormItem = ({ isShow, layout, form, editable, field, config, labelType }: any) => {
  ...
  const payeeList = useSelector(({ PHCLMOfCTG008DataCaptureController: modelnamespace }: any) =>
    lodash.compact(
  ...
  const CurrentId = useSelector(
    ({ PHCLMOfCTG008DataCaptureController }) => PHCLMOfCTG008DataCaptureController.selectedPayeeId
  );
