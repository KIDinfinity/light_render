...
const OutstandingPayoutAmount = ({ field, config, isShow, layout, form, editable }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
...
OutstandingPayoutAmount.displayName = localFieldConfig.field;

export default OutstandingPayoutAmount;
