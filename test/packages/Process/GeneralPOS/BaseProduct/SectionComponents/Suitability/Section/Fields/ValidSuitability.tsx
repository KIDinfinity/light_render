...
import { localFieldConfig } from './ValidSuitability.config';

export { localFieldConfig } from './ValidSuitability.config';
...
ValidSuitability.displayName = localFieldConfig.field;

export default ValidSuitability;
