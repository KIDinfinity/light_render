...
import { localFieldConfig } from './SwitchOutPerc.config';

export { localFieldConfig } from './SwitchOutPerc.config';
...
const SwitchOutPerc = ({ isShow, layout, form, editable, config }: any) => (
  <Authority>
    <FormItem
      config={config}
      isShow={isShow}
...
SwitchOutPerc.displayName = localFieldConfig.field;

export default SwitchOutPerc;
