...
import { localFieldConfig } from './IcpOption.config';

export { localFieldConfig } from './IcpOption.config';
...
export const FormItem = ({
  ...
  return (
    ...
    ((config?.visible || fieldProps.visible) === Visible.Conditions
      ...
      <Col {...layout}>
        <FormItemSelect
          getPopupContainer={() => document.querySelector('.ChangeICP') || document.body}
          dicts={dicts}
          disabled={
            !editable ||
