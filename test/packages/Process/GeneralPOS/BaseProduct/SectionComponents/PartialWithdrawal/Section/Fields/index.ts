...
import ChargeRate, { localFieldConfig as ChargeRateConfig } from './ChargeRate';
import PartialWithdrawalReason, {
  localFieldConfig as PartialWithdrawalReasonConfig,
} from './PartialWithdrawalReason';
