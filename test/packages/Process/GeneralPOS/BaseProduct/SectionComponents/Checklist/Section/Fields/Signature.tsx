...
import { fieldConfig } from './Signature.config';

export { fieldConfig } from './Signature.config';
...
const Signature = ({ field, config, form, editable, layout, isShow, roleDicts, remark }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
...
Signature.displayName = fieldConfig.field;
