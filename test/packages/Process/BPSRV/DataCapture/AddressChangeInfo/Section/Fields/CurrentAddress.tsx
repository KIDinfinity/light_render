...
import { localFieldConfig } from './CurrentAddress.config';
import useJudgeNewClientDisabled from 'process/NB/ManualUnderwriting/_hooks/useJudgeNewClientDisabled';

export { localFieldConfig } from './CurrentAddress.config';
...
const CurrentAddress = ({ isShow, layout, form, editable, section }: any) => (
  <Authority>
...
CurrentAddress.displayName = localFieldConfig.field;
