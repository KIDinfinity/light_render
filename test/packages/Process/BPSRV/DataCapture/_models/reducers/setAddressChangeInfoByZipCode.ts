...
export default (state: any, { payload }: any) =>
  produce(state, (draftState: any) => {
    ...
    if (lodash.isPlainObject(draftState.entities.transactionTypesMap[id].policyAddr.addressLine5)) {
    ...
    if (lodash.isPlainObject(draftState.entities.transactionTypesMap[id].policyAddr.addressLine4)) {
