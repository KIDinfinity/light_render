...
import { localFieldConfig } from './ReasonforChange.config';

export { localFieldConfig } from './ReasonforChange.config';
...
const ReasonforChange = ({ isShow, layout, form, editable, section, id }: any) => (
  <Authority>
...
ReasonforChange.displayName = localFieldConfig.field;
