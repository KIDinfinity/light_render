import changeBasicInfoFieldsValue from 'process/NB/ManualUnderwriting/_models/reducers/changeBasicInfoFieldsValue';
//
...
describe('test changeBasicInfoFieldsValue ', () => {
  test('test change', () => {
    const state = {
      businessDataValue: {
        policyList: [
    ...
    const result = changeBasicInfoFieldsValue(state, action);
