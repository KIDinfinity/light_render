...
import { fieldConfig } from './Businessaddress3.config';
import { tenant, Region } from '@/components/Tenant';

export { fieldConfig } from './Businessaddress3.config';
...
const Businessaddress3 = ({ form, editable, layout, isShow, id, addressInfoList, config }: any) => {
  return (
    <Authority>
      <FormItem
...
Businessaddress3.displayName = 'businessAddress3';

export default Businessaddress3;
