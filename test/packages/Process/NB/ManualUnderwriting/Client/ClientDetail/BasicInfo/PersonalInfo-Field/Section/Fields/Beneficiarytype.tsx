...
import useGetBeneficiarytype from 'process/NB/ManualUnderwriting/_hooks/useGetBeneficiarytype';
...
const FormItem = ({ isShow, layout, form, editable, field, config }: any) => {
  ...
  const dicts = useGetBeneficiarytype({ config, fieldConfig });
...
const Beneficiarytype = ({ form, editable, layout, isShow, config }: any) => {
  return (
    <Authority>
      <FormItem
