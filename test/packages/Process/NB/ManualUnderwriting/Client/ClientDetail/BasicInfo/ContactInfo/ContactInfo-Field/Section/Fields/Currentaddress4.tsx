...
import { fieldConfig } from './Currentaddress4.config';

export { fieldConfig } from './Currentaddress4.config';
...
const ItemSelectTH = ({
  ...
  const dicts = useGetCascadeAdress({ level: 2, form, type: 'current' });
  ...
  const handlerChange = (value) => {
    ...
    dispatch({
      ...
      payload: {
        changedFields: { currentZipCode: item.postalCode },
        id,
      },
    });
  };
...
Currentaddress4.displayName = 'currentAddress4';

export default Currentaddress4;
