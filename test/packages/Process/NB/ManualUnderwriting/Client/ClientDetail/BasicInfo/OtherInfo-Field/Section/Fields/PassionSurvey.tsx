...
import { fieldConfig } from './PassionSurvey.config';

export { fieldConfig } from './PassionSurvey.config';
...
const PassionSurvey = ({ form, editable, layout, isShow, config }: any) => {
  return (
    <Authority>
      <FormItem
...
PassionSurvey.displayName = 'passionSurvey';

export default PassionSurvey;
