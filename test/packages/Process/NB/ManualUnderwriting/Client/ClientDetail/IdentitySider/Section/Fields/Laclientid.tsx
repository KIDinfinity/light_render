...
const Laclientid = ({ field, config, form, editable, layout, isShow }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
...
Laclientid.displayName = 'laClientId';

export default Laclientid;
