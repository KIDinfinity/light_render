...
import ExclusionFields, { localFieldConfigs as ExclusionFieldConfigs } from './Fields/Exclusion';
...
const localConfig = {
  configs: [localSectionConfig, ...ExclusionFieldConfigs],
  remote: true,
};
...
export { ExclusionFields, localConfig };
