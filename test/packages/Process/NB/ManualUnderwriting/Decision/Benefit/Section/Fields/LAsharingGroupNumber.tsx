...
const FormItem = ({ isShow, layout, form, editable, field, config, coverageItem }: any) => {
  ...
  const requiredConditions = useGetHasFamilyGroupInd();
...
const LASharingGroupNumber = ({ form, editable, layout, isShow, config, coverageItem }: any) => {
  return (
    <Authority>
      <FormItem
