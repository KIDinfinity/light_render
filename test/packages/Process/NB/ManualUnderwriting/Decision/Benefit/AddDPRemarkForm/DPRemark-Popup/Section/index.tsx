...
const PostponeDeclineRemarkpopup = ({ form, editable, children }: any) => (
  <Section section="PostponeDeclineRemark-Popup" form={form}>
    {React.Children.map(children, (child: any) =>
      React.cloneElement(child, { form, editable, section: 'PostponeDeclineRemark-Popup' })
    )}
  </Section>
);
const Fields = {
...
export default PostponeDeclineRemarkpopup;
