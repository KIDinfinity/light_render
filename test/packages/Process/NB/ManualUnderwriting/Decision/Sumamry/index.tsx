...
import PolicyLevelDecision from 'process/NB/ManualUnderwriting/Decision/Show/PolicyLevelDecision';
...
import Header from 'process/NB/ManualUnderwriting/Decision/Show/Header';
import styles from 'process/NB/ManualUnderwriting/Decision/Show/index.less';

const DecisionContent = ({ expendStatus, setExpendStatus }: any) => {
  ...
  return (
    <div className={styles.wrap}>
      <Header expendStatus={expendStatus} setExpendStatus={setExpendStatus} dispalyExpandButton />
      {expendStatus && (
        <>
          <PolicyLevelDecision />
...
const Decision = () => {
  return (
    <ExpandableContainer section="decision">
      <DecisionContent />
    </ExpandableContainer>
  );
};
