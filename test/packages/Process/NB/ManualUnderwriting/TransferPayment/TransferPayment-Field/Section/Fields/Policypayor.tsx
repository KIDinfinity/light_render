...
import { fieldConfig } from './Policypayor.config';

export { fieldConfig } from './Policypayor.config';
...
const Policypayor = ({ form, editable, layout, isShow, config, field }: any) => (
  <Authority>
    <FormItem
      isShow={isShow}
      layout={layout}
...
Policypayor.displayName = 'policyPayor';

export default Policypayor;
