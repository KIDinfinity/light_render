...
import { fieldConfig } from './Otherreason.config';

export { fieldConfig } from './Otherreason.config';
...
const FormItem = ({ isShow, layout, form, editable, field, config }: any) => {
  ...
  const editableConditions = form.getFieldValue('reasonForPolicyReplacement') !== 'Others';
...
const Otherreason = ({ field, config, form, editable, layout, isShow }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
