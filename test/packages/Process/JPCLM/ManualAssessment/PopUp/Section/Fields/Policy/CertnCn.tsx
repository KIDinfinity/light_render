...
export const fieldConfig = {
  ...
  field: 'premiumPaymentPeriod',
  'field-props': {
    label: {
      dictTypeCode: 'Label_BIZ_Policy',
      dictCode: 'PremiumPaymentPeriod',
    },
    editable: 'N',
    required: 'N',
    visible: 'Y',
...
const CertnCn = ({ field, config, form, editable, layout, isShow }: any) => (
  <Authority>
    <FormItem field={field} config={config} isShow={isShow} layout={layout} form={form} editable={editable} />
  </Authority>
);

CertnCn.displayName = 'premiumPaymentPeriod';

export default CertnCn;
