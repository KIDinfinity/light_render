...
const localFieldConfig = {
  ...
  field: 'uninsuredPartCN2',
  'field-props': {
    editable: 'N',
    label: {
      dictTypeCode: 'Label_BIZ_Policy',
      dictCode: 'Noncollateralizedpart2',
    },
    required: 'N',
    visible: 'Y',
    'x-dict': {
...
const UninsuredPartCn2 = ({ form, editable, layout, isShow, existCodes, field, config }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
...
UninsuredPartCn2.displayName = 'uninsuredPartCn2';

export default UninsuredPartCn2;
