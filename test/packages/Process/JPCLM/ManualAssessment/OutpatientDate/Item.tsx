...
const Item = ({ treatmentId, diagnosisIdList, outpatientDateList, group, incidentId }: any) => {
  ...
  const deleteDates = (deleteDate: any) => () => {
    if (deleteDate) {
      dispatch({
        type: 'JPCLMOfClaimAssessment/opTreatmentListDelete',
        payload: {
          treatmentId,
          deleteDate,
        },
  ...
  const addDiagnosisItem = () => () => {
    dispatch({
      type: 'JPCLMOfClaimAssessment/opTreatmentListDiagnosisListAdd',
      payload: {
        treatmentId,
        group,
      },
  ...
  const deleteDiagnosis = (diagnosisNameId: any) => () => {
    dispatch({
      type: 'JPCLMOfClaimAssessment/opTreatmentListDiagnosisListDelete',
      payload: {
        treatmentId,
        group,
        diagnosisNameId,
