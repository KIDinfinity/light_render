...
const localFieldConfig = {
  ...
  'field-props': {
    ...
    label: {
      ...
      dictCode: 'app.navigator.task-detail-of-claim-assessment.beneficiary.label.bank-account-no',
    },
    maxLength: 40,
    'x-layout': {
      // 480px
...
const BankAccountNo = ({ field, config, isShow, layout, form, editable, }: any) => (
  <Authority>
