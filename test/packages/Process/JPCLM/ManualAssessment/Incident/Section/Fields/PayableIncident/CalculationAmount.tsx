...
const CalculationAmount = ({ field, config, isShow, layout, form, editable }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
...
CalculationAmount.displayName = 'CalculationAmount';

export default CalculationAmount;
