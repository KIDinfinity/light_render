...
const AnnuityPayToTimes = ({ field, config, isShow, layout, form, editable }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
...
AnnuityPayToTimes.displayName = 'AnnuityPayToTimes';

export default AnnuityPayToTimes;
