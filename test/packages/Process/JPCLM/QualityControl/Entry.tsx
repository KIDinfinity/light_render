...
import SubmissionDate from '../ManualAssessment/Header/SubmissionDate';
import InformationPerfectionDate from '../ManualAssessment/Header/InformationPerfectionDate';
        ...
        <BPM.HeaderInfoContainer>
          <BPM.HeaderInfo>
            ...
            <BPM.HeaderInfoItem
              ...
              title={formatMessageApi({
                Label_BIZ_Claim: 'informationPerfectionDate',
              })}
              render={() => (
