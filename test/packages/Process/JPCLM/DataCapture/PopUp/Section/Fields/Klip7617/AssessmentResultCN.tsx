...
const localFieldConfig = {
  ...
  field: 'assessmentResultCN',
  'field-props': {
    editable: 'Y',
    label: {
      dictTypeCode: 'Label_BIZ_Claim',
      dictCode: 'DetailedAssessment',
    },
    required: 'N',
    visible: 'Y',
    'x-dict': {
      dictTypeCode: 'assessmentResult',
    },
    'x-layout': {
      // 480px
      xs: {
...
const AssessmentResultCN = ({ field, config, form, editable, layout, isShow }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
...
AssessmentResultCN.displayName = 'AssessmentResultCN';

export default AssessmentResultCN;
