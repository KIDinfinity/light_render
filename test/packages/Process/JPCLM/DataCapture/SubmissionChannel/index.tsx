...
class SubmissionChannel extends Component<IProps> {
  ...
  render() {
    const { form, taskNotEditable, submissionChannelList, submissionChannel } = this.props;
...
export default connect(
  ({ claimEditable, JPCLMOfDataCapture, formCommonController, dictionaryController }: any) => ({
    taskNotEditable: claimEditable.taskNotEditable,
    submissionChannelList: dictionaryController.Dropdown_COM_SubmissionChannel || [],
    submissionChannel: JPCLMOfDataCapture.claimProcessData?.submissionChannel,
