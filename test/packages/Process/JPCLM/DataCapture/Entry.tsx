...
import SubmissionDate from './Header/SubmissionDate';
import InformationPerfectionDate from './Header/InformationPerfectionDate';
        ...
        <BPM.HeaderInfoContainer>
          <BPM.HeaderInfo>
            ...
            <BPM.HeaderInfoItem
              ...
              })}
              {
                ...(getIsMenuCreateCase(taskDetail)
                    ? {render: () => <MenuCreateClaimNoEdit taskDetail={taskDetail} />}
            ...
            <BPM.HeaderInfoItem
              ...
              render={() => (
                <InformationPerfectionDate bpmSubmissionDate={taskDetail.submissionDate} />
              )}
            />
            <BPM.HeaderInfoItem
              key="submissionDate"
              ...
              render={() => <SubmissionDate bpmSubmissionDate={taskDetail.submissionDate} />}
            />
            {/* <BPM.HeaderInfoItem
            key="submissionTime"
            title={formatMessageApi({
          ...
          /> */}
            <BPM.HeaderInfoItem
              ...
              {...(taskDetail?.submissionChannel === ESubmissionChannel.PAPERSUBMISSION
                ? {
                ...
                : {
                  renderValue: () => {
                    return formatMessageApi({
                      Dropdown_COM_SubmissionChannel: taskDetail?.submissionChannel,
                    });
                  },
                })}
            />
