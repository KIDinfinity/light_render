...
const localFieldConfig = {
  ...
  'field-props': {
    ...
    label: {
      ...
      dictCode: 'physicalDisability',
    },
    'x-dict': { dictTypeCode: 'Dropdown_CLM_PDState' },
    'x-layout': {
      //  TODO: 动态layout
      // 480px
      xs: {
...
const PhysicalDisability = ({ field, config, isShow, layout, form, editable }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
...
PhysicalDisability.displayName = localFieldConfig.field;
