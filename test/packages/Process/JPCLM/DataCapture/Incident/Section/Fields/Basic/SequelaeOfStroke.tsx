...
export const fieldConfig = {
  ...
  field: 'sequelaeOfStroke',
  'field-props': {
    label: {
      dictTypeCode: 'Label_BIZ_Claim',
      dictCode: 'SequelaeOfStroke',
    },
    visible: 'Y',
    expand: 'N',
    'x-layout': {
    ...
    'x-dict': {
      dictTypeCode: 'Dropdown_CLM_SequelaeOfStroke',
    },
  },
};
...
const FormItem = ({ isShow, layout, form, editable, field, config }: any) => {
  ...
  const dictsOfSequelaeOfStroke = useSelector(
...
const SequelaeOfStroke = ({ field, config, form, editable, layout, isShow }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
...
SequelaeOfStroke.displayName = 'SequelaeOfStroke';

export default SequelaeOfStroke;
