...
const localFieldConfig = {
  ...
  field: 'therapeuticMonth',
  'field-props': {
    dateFormat: 'L',
    editable: 'Y',
    label: {
      dictTypeCode: 'Label_BIZ_Claim',
      dictCode: 'therapeuticMonth',
    },
    required: 'C',
    'required-condition': {
      combine: '||',
...
const TherapeuticMonth = ({ field, config, form, editable, layout, isShow }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
...
TherapeuticMonth.displayName = localFieldConfig.field;

export default TherapeuticMonth;
