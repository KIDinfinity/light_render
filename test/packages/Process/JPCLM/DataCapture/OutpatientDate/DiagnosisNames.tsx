...
export default connect(({ JPCLMOfDataCapture, formCommonController }: any) => ({
  validating: formCommonController.validating,
  diagnosisListMap: JPCLMOfDataCapture.claimEntities.diagnosisListMap,
}))(
  Form.create<any>({
    ...
    onFieldsChange(props, changedFields) {
      ...
      if (!validating) {
        dispatch({
          type: 'JPCLMOfDataCapture/opTreatmentListDiagnosisListUpdate',
          payload: {
            treatmentId,
            group,
            changedFields,
