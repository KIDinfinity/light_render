...
@connect(({ JPCLMProcessCreate, formCommonController }: any, { treatmentId }: any) => ({
  ...
  caseCategory: lodash.get(JPCLMProcessCreate, 'claimProcessData.caseCategory'),
}))
class InvoiceList extends Component {
  handleAdd = () => {
    ...
    dispatch({
      type: 'JPCLMProcessCreate/addInvoiceItem',
      payload: {
        treatmentId,
        addInvoiceItem,
        addServiceItem,
