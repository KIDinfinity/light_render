...
const mapStateToProps = ({ JPCLMProcessCreate, formCommonController }, { incidentId }) => {
  const { claimEntities } = JPCLMProcessCreate;
...
class DiagnosisList extends Component<IProps> {
  handleAdd = () => {
    ...
    dispatch({
      type: 'JPCLMProcessCreate/addDiagnosisItem',
      payload: {
        incidentId,
        addDiagnosisItem,
      },
