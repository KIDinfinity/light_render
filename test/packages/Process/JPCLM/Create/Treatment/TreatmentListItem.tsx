...
@connect(({ JPCLMProcessCreate, claimEditable }: any, { treatmentId }: any) => ({
  treatmentNo: JPCLMProcessCreate.claimEntities.treatmentListMap[treatmentId].treatmentNo,
}))
class TreatmentItem extends PureComponent {
  ...
  handleDelete = () => {
    ...
    dispatch({
      type: 'JPCLMProcessCreate/removeTreatmentItem',
      payload: {
        incidentId,
        treatmentId,
      },
