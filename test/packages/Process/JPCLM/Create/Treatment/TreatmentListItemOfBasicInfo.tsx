...
@connect(
  (
    ...
    treatmentItem: JPCLMProcessCreate.claimEntities.treatmentListMap[treatmentId],
    incidentItem: JPCLMProcessCreate.claimEntities.incidentListMap[incidentId],
...
@Form.create<IProps>({
  onFieldsChange(props, changedFields) {
    ...
    dispatch({
      type: 'JPCLMProcessCreate/saveTreatmentItem',
      payload: {
