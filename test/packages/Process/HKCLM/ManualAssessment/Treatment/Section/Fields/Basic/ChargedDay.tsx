...
import useCalcChargedDateMaxValue from 'process/HKCLM/ManualAssessment/_hooks/useCalcChargedDateMaxValue';
...
export const FormItem = ({ isShow, layout, form, editable, field, config }: any) => {
  ...
  const { id: treatmentId }: any = form.getFieldsValue(['id']);
...
const ChargedDay = ({ field, config, isShow, layout, form, editable }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
