...
export const FormItem = ({
  ...
  const editableConditions =
    !!isServiceItemRequired(form.getFieldValue('serviceItem')) &&
    serviceItemBreakdownItem.editable !== BreakDown.NO;
...
const Unit = ({ field, config, isShow, layout, form, editable, treatmentId, breakDownId }: any) => (
  <Authority>
    <FormItem
