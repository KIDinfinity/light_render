...
const localConfig = {
  configs: [localSectionConfig, ...FieldConfigs, ...AddFieldConfigs],
  remote: true,
};
...
const Section = ({ form, editable, children, layoutName, section }: any) => (
  <FormSection section={section} layoutName={layoutName}>
...
export { Fields, AddFields, SectionTitle, SectionColumns, localConfig };
