...
const PopUpPayable = () => {
  ...
  const customWidth = transformLengthByScreen(820);
  const top = Number(popUpPablePoint?.top) + transformLengthByScreen(32);
  const left = Number(popUpPablePoint?.left) - transformLengthByScreen(customWidth);
