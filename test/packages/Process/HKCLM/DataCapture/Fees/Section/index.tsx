...
import Fields, { localFieldConfigs as FieldConfigs } from './Fields/Basic';
import FieldsAdd, { localFieldConfigs as FieldAddConfigs } from './Fields/Add';
...
const localConfig = {
  configs: [localSectionConfig, ...FieldConfigs, ...FieldAddConfigs],
  remote: true,
};
...
export { Fields, FieldsAdd, SectionTitle, SectionColumns, localConfig };
