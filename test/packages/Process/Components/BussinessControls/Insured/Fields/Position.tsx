...
import { localFieldConfig } from './Position.config';
...
const Position = ({ field, config, isShow, layout, form, editable, NAMESPACE, id }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
...
Position.displayName = localFieldConfig.field;
