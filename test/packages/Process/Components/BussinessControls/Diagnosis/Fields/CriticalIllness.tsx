...
import { localFieldConfig } from './CriticalIllness.config';

export { localFieldConfig } from './CriticalIllness.config';
...
const CriticalIllness = ({ field, config, isShow, layout, form, editable, NAMESPACE, id }: any) => (
  <Authority>
