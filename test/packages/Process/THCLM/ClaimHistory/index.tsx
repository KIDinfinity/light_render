...
@connect(({ THCLMOfClaimAssessmentController, workspaceHistory }) => ({
  claimProcessData: THCLMOfClaimAssessmentController.claimProcessData,
...
class ClaimApprove extends Component {
  ...
  componentWillUnmount = () => {
    ...
    dispatch({
      type: 'THCLMOfClaimAssessmentController/clearClaimProcessData',
    });
  ...
  getDropdown = () => {
    ...
    dispatch({
      type: 'THCLMOfClaimAssessmentController/queryListPolicy',
      payload: {
        claimNo: businessNo,
      },
    });
    ...
    dispatch({
      ...
      payload: dictionaryConfig?.THhistory,
    });
    ...
    dispatch({
      type: 'THCLMOfClaimAssessmentController/getAgentNoList',
      payload: {
        claimNo: businessNo,
      },
    });
  ...
  handleAllocationClose = () => {
    ...
    backData?.then?.((claimData: any) => {
      if (!lodash.isEmpty(claimData)) {
        dispatch({
          type: 'THCLMOfClaimAssessmentController/savePaymentAllocation',
          payload: claimData,
        });
      }
    });
    ...
    return (
      <PageContainer pageConfig={{}}>
        ...
        <div className={styles.container}>
          ...
          <FurtherClaimModal namespace="THCLMOfClaimAssessmentController" />
        </div>
      </PageContainer>
    );
  }
