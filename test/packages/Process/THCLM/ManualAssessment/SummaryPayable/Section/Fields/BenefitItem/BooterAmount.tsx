...
import { localFieldConfig } from './BooterAmount.config';

export { localFieldConfig } from './BooterAmount.config';
...
const BooterAmount = ({ field, config, isShow, layout, form, editable, originAmount }: any) => (
  <Authority>
    <FormItem
      field={field}
      config={config}
...
BooterAmount.displayName = 'boosterAmount';

export default BooterAmount;
