...
import { getExistDiagnosisCode } from 'claim/pages/utils/selector';
...
export const FormItem = ({
  ...
  const existDiagnosisCode = useMemo(() => getExistDiagnosisCode(incidentId, diagnosisListMap), [
    diagnosisListMap,
  ]);
  ...
  const searchIsCIByDiagnosisCode = (value: string) => {
    if (lodash.includes(existDiagnosisCode, value)) {
