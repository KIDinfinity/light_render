...
@connect(({ hkProcessController }: any) => ({
  submited: hkProcessController.submited,
...
class IncidentItem extends PureComponent {
  handleDelete = () => {
    ...
    dispatch({
      type: 'hkProcessController/removeIncidentItem',
      payload: {
        incidentId,
      },
    });
  ...
  handleAdd = () => {
    ...
    dispatch({
      type: 'hkProcessController/addTreatmentItem',
      payload: {
        incidentId,
        addTreatmentItem,
        addInvoiceItem,
  ...
  onClose = () => {
    ...
    dispatch({
      type: 'hkProcessController/setIncidentItemExpandStatus',
      payload: {
        id: incidentId,
        status: false,
      },
  ...
  render() {
    const { incidentId, incidentItem, incidentItemExpandStatus, submited }: any = this.props;
