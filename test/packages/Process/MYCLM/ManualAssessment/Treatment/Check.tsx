...
export default connect(
  ({ formCommonController, MYCLMOfCTG008AssessmentController }: any, { treatmentId }: any) => ({
    treatmentItem: MYCLMOfCTG008AssessmentController.claimEntities.treatmentListMap[treatmentId],
    ...
    onFieldsChange(props: any, changedFields: any) {
      ...
      if (formUtils.shouldUpdateState(changedFields)) {
        if (validating) {
          setTimeout(() => {
            dispatch({
              type: 'MYCLMOfCTG008AssessmentController/saveEntry',
          ...
          dispatch({
            type: 'MYCLMOfCTG008AssessmentController/saveFormData',
            target: 'saveTreatmentItem',
            payload: {
              changedFields: temChangedFields,
              incidentId,
