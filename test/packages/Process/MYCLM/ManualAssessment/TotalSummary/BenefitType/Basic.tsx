...
const Basic = ({ form, basicItem, existBenefitType, isLabel, isPayableEditable }: any) => {
  ...
  const payableAmountProps = ![undefined, 0].includes(basicItem?.systemCalculationAmount)
    ? { originAmount: basicItem.systemCalculationAmount }
    : {};
  ...
  return (
    <div className={styles.basicItem}>
      ...
      >
        ...
        <BenefitTypeFields.PayableAmount {...payableAmountProps} />
...
export default connect(({ formCommonController }: any) => ({
  ...
  Form.create<any>({
    onFieldsChange(props: any, changedFields: any) {
      ...
      if (!props.isPayableEditable) return;
