...
const SearchInsuredModal = ({ taskDetail }: any) => {
  ...
  const showInsuredList = useSelector(
    ({ documentScanningController }: any) => documentScanningController.showInsuredList
  );
  const documentManagement = useSelector(({ documentManagement }: any) => documentManagement);
