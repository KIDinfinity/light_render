...
const Section = ({ form, editable, children, layoutName, section, handleChange }: any) => (
  <FormSection section={section} layoutName={layoutName} form={form} handleChange={handleChange}>
    {React.Children.map(children, (child: any) =>
      React.cloneElement(child, { form, editable, section, handleChange })
    )}
  </FormSection>
);

export { Fields, SectionTitle, localConfig, localSectionConfig };
