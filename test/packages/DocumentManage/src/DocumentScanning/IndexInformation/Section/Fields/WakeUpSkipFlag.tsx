...
import { fieldConfig } from './WakeUpSkipFlag.config';

export { fieldConfig } from './WakeUpSkipFlag.config';

export const FormItem = ({ isShow, layout, form, editable, field, config }: any) => {
  const fieldProps: any = fieldConfig['field-props'];
  const dictsOfClaimType = useSelector(
    ({ dictionaryController }: any) => dictionaryController.Dropdown_COM_Indicator
  );
