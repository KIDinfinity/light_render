...
const localSectionConfig = {
  ...
  'section-props': {
    label: {
      dictTypeCode: 'Label_COM_Document',
      dictCode: 'IndexingInformation',
    },
    visible: 'Y',
    'x-layout': {
      // 480px
...
const Section = ({ form, editable, children, layoutName, section, ...rest }: any) => (
  <FormSection section={section} layoutName={layoutName} form={form}>
    {React.Children.map(children, (child: any) =>
      React.cloneElement(child, { form, editable, section, ...rest })
    )}
  </FormSection>
);
