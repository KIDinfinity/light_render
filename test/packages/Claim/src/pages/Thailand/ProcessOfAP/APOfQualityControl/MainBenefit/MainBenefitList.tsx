...
@connect(
  (
    ...
    claimNo: lodash.get(apOfClaimCaseController, 'claimProcessData.claimNo'),
    mainBenefitList:
      apOfClaimCaseController.claimEntities.treatmentListMap[treatmentId]?.mainBenefitList,
    mainBenefitListMap: apOfClaimCaseController.claimEntities.mainBenefitListMap,
...
class MainBenefitList extends Component<IProps> {
  ...
  handleAdd = () => {
    ...
    dispatch({
      type: 'apOfClaimCaseController/addMainBenefitItem',
      payload: {
        treatmentId,
        addMainBenefitItem,
      },
