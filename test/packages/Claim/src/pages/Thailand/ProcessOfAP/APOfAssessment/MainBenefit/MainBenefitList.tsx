...
@connect(
  (
    ...
    mainBenefitList:
      apOfClaimAssessmentController.claimEntities.treatmentListMap[treatmentId]?.mainBenefitList,
    mainBenefitListMap: apOfClaimAssessmentController.claimEntities.mainBenefitListMap,
...
class MainBenefitList extends Component<IProps> {
  ...
  handleAdd = () => {
    ...
    dispatch({
      type: 'apOfClaimAssessmentController/addMainBenefitItem',
      payload: {
        treatmentId,
        addMainBenefitItem,
      },
  ...
  render() {
    ...
    return (
      <div
        className={taskNotEditable && lodash.isEmpty(mainBenefitList) ? '' : styles.mainBenefitCard}
      >
        <div>
