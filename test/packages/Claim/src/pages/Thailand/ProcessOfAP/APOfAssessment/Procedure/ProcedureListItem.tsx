...
@connect(
  (
    { apOfClaimAssessmentController, formCommonController, claimEditable, processTask }: any,
    { procedureId }: any
  ) => ({
    procedureItem: apOfClaimAssessmentController.claimEntities.procedureListMap[procedureId],
    validating: formCommonController.validating,
    taskNotEditable: claimEditable.taskNotEditable,
    procedureListMap: apOfClaimAssessmentController.claimEntities.procedureListMap,
    showSurgicalPackage: apOfClaimAssessmentController.showSurgicalPackage,
  })
)
// @ts-ignore
@Form.create<IProps>({
...
class ProcedureListItem extends Component<IProps> {
  ...
  handleDelete = () => {
    ...
    dispatch({
      type: 'apOfClaimAssessmentController/removeProcedureItem',
      payload: {
        treatmentId,
        procedureId,
      },
