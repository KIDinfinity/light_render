...
@connect(
  ({ daOfClaimCaseController, formCommonController, claimEditable }: any, { invoiceId }: any) => ({
    submited: formCommonController.submited,
    claimNo: daOfClaimCaseController.claimProcessData.claimNo,
    serviceItemList:
      daOfClaimCaseController.claimEntities.invoiceListMap[invoiceId]?.serviceItemList,
    serviceItemListMap: daOfClaimCaseController.claimEntities.serviceItemListMap,
...
class ServiceItemList extends Component<IProps> {
  handleAdd = () => {
    ...
    dispatch({
      type: 'daOfClaimCaseController/addServiceItem',
      payload: {
        invoiceId,
        addServiceItem,
      },
