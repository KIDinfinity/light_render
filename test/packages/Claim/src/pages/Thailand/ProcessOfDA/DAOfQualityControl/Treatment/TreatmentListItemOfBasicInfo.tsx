...
@connect(
  (
    ...
    treatmentItem: daOfClaimCaseController.claimEntities.treatmentListMap[treatmentId],
    ...
    submissionDate: daOfClaimCaseController.claimProcessData.submissionDate,
  })
)
// @ts-ignore
@Form.create<IProps>({
