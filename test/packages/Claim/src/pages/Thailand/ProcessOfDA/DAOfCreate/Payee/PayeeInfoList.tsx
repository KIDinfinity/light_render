...
class PayeeInfoList extends Component {
  handleAdd = () => {
    ...
    dispatch({
      type: 'daProcessController/addPayeeInfoItem',
    });
  };
...
export default connect(({ daProcessController, claimEditable }: any) => ({
  taskNotEditable: claimEditable.taskNotEditable,
  payeeList: lodash.get(daProcessController, 'claimProcessData.payeeList'),
}))(PayeeInfoList);
