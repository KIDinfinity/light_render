...
@connect(({ daProcessController, formCommonController }: any, { invoiceId }: any) => ({
  submited: formCommonController.submited,
  claimNo: daProcessController.claimProcessData.claimNo,
  serviceItemList: daProcessController.claimEntities.invoiceListMap[invoiceId]?.serviceItemList,
  serviceItemListMap: daProcessController.claimEntities.serviceItemListMap,
}))
class ServiceItemList extends Component<IProps> {
  handleAdd = () => {
    ...
    dispatch({
      type: 'daProcessController/addServiceItem',
      payload: {
        invoiceId,
        addServiceItem,
      },
