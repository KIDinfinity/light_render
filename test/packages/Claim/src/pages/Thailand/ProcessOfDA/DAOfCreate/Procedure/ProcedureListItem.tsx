...
@connect(({ daProcessController, formCommonController }: any, { procedureId }: any) => ({
  procedureItem: daProcessController.claimEntities.procedureListMap[procedureId],
  validating: formCommonController.validating,
  procedureListMap: daProcessController.claimEntities.procedureListMap,
}))
// @ts-ignore
@Form.create<IProps>({
  onFieldsChange(props: any, changedFields: any) {
    ...
    dispatch({
      type: 'daProcessController/saveProcedureItem',
      payload: {
        changedFields,
        treatmentId,
        procedureId,
...
class ProcedureListItem extends Component<IProps> {
  ...
  handleDelete = () => {
    ...
    dispatch({
      type: 'daProcessController/removeProcedureItem',
      payload: {
        treatmentId,
        procedureId,
      },
  ...
  render() {
    const { form, dataIndex, procedureListMap }: any = this.props;
