...
@connect(
  ({ daOfClaimAssessmentController, claimEditable, processTask }: any, { treatmentId }: any) => ({
    claimNo: lodash.get(daOfClaimAssessmentController, 'claimProcessData.claimNo'),
    procedureList: getProcedureList(
      treatmentId,
      daOfClaimAssessmentController.claimEntities.procedureListMap
    ),
...
class ProcedureList extends Component<IProps> {
  componentDidMount(): void {
    ...
    dispatch({
      type: 'daOfClaimAssessmentController/initProcedureItemConfig',
      payload: {
  ...
  handleAdd = () => {
    ...
    dispatch({
      type: 'daOfClaimAssessmentController/addProcedureItem',
      payload: {
        treatmentId,
        addProcedureItem,
      },
