...
import actionConfig from './actionConfig.assessment';
import ErrorsUpdate from './Entry.Assessment.ErrorUpdate';
  ...
  const Dom = useMemo(
    () => (
      <BPM>
        ...
        />
        <ErrorsUpdate setShowRequiredError={setShowRequiredError} />
      </BPM>
    ),
    [taskDetail, businessData, showRequiredError]
  );
  return Dom;
};
