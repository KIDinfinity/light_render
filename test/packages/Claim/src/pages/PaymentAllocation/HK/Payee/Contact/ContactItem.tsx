...
const Contact: FunctionComponent<IContact> = ({
  ...
  const { disabledConfig } = useContactHook({ payeeItem });
    ...
    <>
      <DataLayout span={8}>
        ...
        <FormItemInput
          ...
          disabled={taskNotEditable || disabledConfig?.telNo}
          formName="telNo"
          maxLength={20}
...
const FormWrap = Form.create<IContact>({
  ...
  onFieldsChange(props, changedFields) {
    const { dispatch, contactItem, countryCode, withData, validating } = props;
