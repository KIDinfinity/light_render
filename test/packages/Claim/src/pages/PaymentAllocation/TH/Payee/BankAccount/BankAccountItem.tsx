...
const BankAccountItem: FunctionComponent<IBankAccount> = ({
  ...
  // const handleAccountNo = (value: any) => {
  //   const bankAccount = handleBankAccount.getBankAccountItem({
  //     clientId,
  //     bankAccountList,
  //     id: value,
  //   });
  //   if (bankAccount) {
  //     const { bankCode, branchCode } = lodash.pick(bankAccount, ['bankCode', 'branchCode']);
  //     getBankAccount({ bankCode, regionCode, dispatch, bankAccountItem, payeeId });
  //     getBankBranch({ branchCode, regionCode, dispatch, bankAccountItem, payeeId });
  //   }
  // };
