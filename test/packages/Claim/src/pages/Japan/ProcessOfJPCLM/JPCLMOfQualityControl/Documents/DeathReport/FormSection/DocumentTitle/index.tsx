    ...
    return (
      ...
      >
        ...
        <FormItemInput
          form={form}
          disabled={taskNotEditable}
          formName="insuredAddress"
          maxLength={240}
          labelId="venus_claim.label.insuredAddress"
        />
        <FormItemDatePicker
          form={form}
          disabled={taskNotEditable}
  ...
  Form.create({
    ...
    mapPropsToFields(props: any) {
      ...
      return formUtils.mapObjectToFields(formData, {
        insuredDateOfBirth: (value: any) => (value ? moment(value) : null),
