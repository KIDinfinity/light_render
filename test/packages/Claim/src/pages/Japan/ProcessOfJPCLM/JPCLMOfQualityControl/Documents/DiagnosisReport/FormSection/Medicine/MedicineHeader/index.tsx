...
class MedicineHeader extends Component<IProps> {
  render() {
    const { form, taskNotEditable, CancerFlagIII, documentId } = this.props;
    return (
      <FormSection
        form={form}
        formId={`MedicineHeader_${documentId}`}
        isHideBgColor
        isPadding={false}
      ...
      >
        <FormItemSelect
          ...
          formName="cancerFlag3rd"
          dicts={CancerFlagIII}
          labelId="venus_claim.label.cancerFlag3rd"
        />
      </FormSection>
    );
  }
