...
@connect(({ hkProcessController, formCommonController, claimEditable }: any) => ({
  incidentList: lodash.get(hkProcessController, 'claimProcessData.incidentList'),
...
class IncidentList extends PureComponent {
  handleAdd = () => {
    ...
    dispatch({
      type: 'hkProcessController/addIncidentItem',
      payload: {
        addIncidentItem,
        addDiagnosisItem,
      },
