...
@connect(
  ({ hkProcessController, dictionaryController, formCommonController, claimEditable }: any) => ({
...
@Form.create<IProps>({
  onFieldsChange(props, changedFields) {
    ...
    dispatch({
      type: 'hkProcessController/saveIncidentItem',
      payload: {
        changedFields,
        incidentId,
      },
...
class IncidentListItemBasicInfo extends PureComponent<IProps> {
  ...
  render() {
    ...
    const dictOfClaimType = lodash.filter(
      dictsOfClaimType,
