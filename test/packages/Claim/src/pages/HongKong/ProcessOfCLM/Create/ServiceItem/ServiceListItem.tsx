...
@connect(
  ({ hkProcessController, formCommonController, claimEditable }: any, { serviceItemId }: any) => ({
    serviceItem: hkProcessController.claimEntities.serviceItemListMap[serviceItemId],
...
@Form.create({
  onFieldsChange(props, changedFields) {
    ...
    dispatch({
      type: 'hkProcessController/saveServiceItem',
      payload: {
        changedFields,
        serviceItemId,
        invoiceId,
...
class ServiceListItem extends PureComponent {
  ...
  handleDelete = () => {
    ...
    dispatch({
      type: 'hkProcessController/removeServiceItem',
      payload: {
        invoiceId,
        serviceItemId,
      },
