...
@connect(
  (
    ...
    procedureItem: HKCLMOfClaimAssessmentController.claimEntities.procedureListMap[procedureId],
    incidentDate:
      HKCLMOfClaimAssessmentController.claimEntities.incidentListMap[incidentId].incidentDate,
...
@Form.create<IProps>({
  onFieldsChange(props: any, changedFields: any) {
    ...
    if (formUtils.shouldUpdateState(changedFields)) {
      dispatch({
        type: 'HKCLMOfClaimAssessmentController/saveProcedureItem',
        payload: {
          changedFields,
          treatmentId,
          procedureId,
...
class ProcedureListItem extends PureComponent<IProps> {
  ...
  handleDelete = () => {
    ...
    dispatch({
      type: 'HKCLMOfClaimAssessmentController/removeProcedureItem',
      payload: {
        treatmentId,
        procedureId,
      },
  ...
  onSelect = (value: any) => {
    ...
    dispatch({
      type: 'HKCLMOfClaimAssessmentController/getCategoryByProcedureCode',
      payload: {
        surgeryCode: value,
        procedureId,
      },
