...
@connect(
  (
    ...
    treatmentItem: PHCLMOfDataCaptureController.claimEntities.treatmentListMap[treatmentId],
    incidentItem: PHCLMOfDataCaptureController.claimEntities.incidentListMap[incidentId],
