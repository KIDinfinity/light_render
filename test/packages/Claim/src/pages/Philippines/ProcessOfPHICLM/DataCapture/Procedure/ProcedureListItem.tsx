...
@connect(
  (
    ...
    procedureItem: PHCLMOfDataCaptureController.claimEntities.procedureListMap[procedureId],
    incidentDate:
      PHCLMOfDataCaptureController.claimEntities.incidentListMap[incidentId].incidentDate,
...
@Form.create<IProps>({
  onFieldsChange(props: any, changedFields: any) {
    ...
    if (formUtils.shouldUpdateState(changedFields)) {
      dispatch({
        type: 'PHCLMOfDataCaptureController/saveProcedureItem',
        payload: {
          changedFields,
          treatmentId,
          procedureId,
...
class ProcedureListItem extends PureComponent<IProps> {
  ...
  handleDelete = () => {
    ...
    dispatch({
      type: 'PHCLMOfDataCaptureController/removeProcedureItem',
      payload: {
        treatmentId,
        procedureId,
      },
