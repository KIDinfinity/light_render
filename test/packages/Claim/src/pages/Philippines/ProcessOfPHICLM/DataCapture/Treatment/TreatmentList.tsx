...
@connect(({ PHCLMOfDataCaptureController, claimEditable }: any, { incidentId }: any) => ({
  claimNo: PHCLMOfDataCaptureController.claimProcessData.claimNo,
  treatmentList:
    PHCLMOfDataCaptureController.claimEntities.incidentListMap[incidentId].treatmentList,
