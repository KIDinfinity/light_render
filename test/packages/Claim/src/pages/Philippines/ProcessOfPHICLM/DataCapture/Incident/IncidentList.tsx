...
@connect(({ PHCLMOfDataCaptureController, formCommonController, claimEditable }: any) => ({
  incidentList: lodash.get(PHCLMOfDataCaptureController, 'claimProcessData.incidentList'),
...
class IncidentList extends PureComponent {
  handleAdd = () => {
    ...
    dispatch({
      type: 'PHCLMOfDataCaptureController/addIncidentItem',
      payload: {
        addIncidentItem,
        addDiagnosisItem,
      },
