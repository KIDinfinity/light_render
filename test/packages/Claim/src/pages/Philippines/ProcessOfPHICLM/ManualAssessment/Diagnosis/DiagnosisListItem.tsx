...
import { VLD_000051 } from 'claim/pages/validators/fieldValidators';
...
@connect(
  (
    ...
    { diagnosisId, incidentId }: any
  ) => ({
    diagnosisItem: PHCLMOfClaimAssessmentController.claimEntities.diagnosisListMap[diagnosisId],
...
class DiagnosisListItem extends PureComponent {
  ...
  handleDelete = () => {
    ...
    dispatch({
      type: 'PHCLMOfClaimAssessmentController/removeDiagnosisItem',
      payload: {
        incidentId,
        diagnosisId,
      },
  ...
  searchIsCIByDiagnosisCode = (value) => {
    ...
    dispatch({
      type: 'PHCLMOfClaimAssessmentController/checkIsCIByDiagnosisCode',
      payload: {
        diagnosisId,
        incidentId,
        searchCode: value,
        ...
        <Form layout="vertical">
          <FormLayout json={hasTreatment ? diagnosisLayout : diagnosisExpendLayout}>
            ...
            <FormItemCheckbox
              ...
              rules={[
                {
                  validator: VLD_000051(submited, incidentItem),
                },
              ]}
