...
@connect(
  (
    ...
    procedureItem: PHCLMOfClaimAssessmentController.claimEntities.procedureListMap[procedureId],
    incidentDate:
      PHCLMOfClaimAssessmentController.claimEntities.incidentListMap[incidentId].incidentDate,
...
@Form.create<IProps>({
  onFieldsChange(props: any, changedFields: any) {
    ...
    if (formUtils.shouldUpdateState(changedFields)) {
      dispatch({
        type: 'PHCLMOfClaimAssessmentController/saveProcedureItem',
        payload: {
          changedFields,
          treatmentId,
          procedureId,
...
class ProcedureListItem extends PureComponent<IProps> {
  ...
  handleDelete = () => {
    ...
    dispatch({
      type: 'PHCLMOfClaimAssessmentController/removeProcedureItem',
      payload: {
        treatmentId,
        procedureId,
      },
