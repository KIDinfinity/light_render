...
@connect(
  ({
    ...
    claimant: lodash.get(PHCLMOfAppealCaseController, 'claimProcessData.claimant'),
    currentState: lodash.get(PHCLMOfAppealCaseController, 'claimProcessData.insured.currentState'),
    validating: formCommonController.validating,
    taskNotEditable: claimEditable.taskNotEditable,
    insured: lodash.get(PHCLMOfAppealCaseController, 'claimProcessData.insured'),
  })
)
// @ts-ignore
@Form.create<IProps>({
...
class ClaimantInfo extends PureComponent<IProps> {
  ...
  render() {
    ...
    const isrelationshipWithInsuredSelf = form.getFieldValue('relationshipWithInsured') === 'SLF';

    const taskNotEditable = true;
