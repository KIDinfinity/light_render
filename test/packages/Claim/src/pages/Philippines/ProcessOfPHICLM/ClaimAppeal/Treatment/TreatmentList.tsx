...
@connect(({ PHCLMOfAppealCaseController }, { incidentId, withData: { caseType } }) => ({
  treatmentList: caseType
    ? PHCLMOfAppealCaseController[caseType].claimEntities.incidentListMap[incidentId].treatmentList
    : PHCLMOfAppealCaseController.claimEntities.incidentListMap[incidentId].treatmentList,
}))
...
export default withContextData(TreatmentList);
