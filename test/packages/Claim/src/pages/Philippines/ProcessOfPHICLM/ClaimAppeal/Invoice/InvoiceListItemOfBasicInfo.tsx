...
@connect(
  (
    ...
    invoiceItem: caseType
      ? PHCLMOfAppealCaseController[caseType].claimEntities.invoiceListMap[invoiceId]
      : PHCLMOfAppealCaseController.claimEntities.invoiceListMap[invoiceId],
...
class InvoiceListItemOfBasicInfo extends PureComponent<IProps> {
  ...
  render() {
    const { form, invoiceListFromEntities, taskNotEditable: notEditable, withData } = this.props;
...
export default withContextData(InvoiceListItemOfBasicInfo);
