...
import { localFieldConfig } from './AddressLine2.config';

export { localFieldConfig } from './AddressLine2.config';
...
const AddressLine2 = ({ isShow, layout, form, editable, section, config }: any) => (
  <Authority>
...
AddressLine2.displayName = localFieldConfig.field;
