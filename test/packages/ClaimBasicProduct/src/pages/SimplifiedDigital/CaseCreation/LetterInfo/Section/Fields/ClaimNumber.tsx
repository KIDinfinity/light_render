...
import { localFieldConfig } from './ClaimNumber.config';

export { localFieldConfig } from './ClaimNumber.config';
...
const ClaimNumber = ({ isShow, layout, form, editable, section, config }: any) => (
  <Authority>
...
ClaimNumber.displayName = localFieldConfig.field;
