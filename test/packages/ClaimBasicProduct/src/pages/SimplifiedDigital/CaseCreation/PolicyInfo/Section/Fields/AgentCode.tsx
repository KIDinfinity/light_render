...
import { localFieldConfig } from './AgentCode.config';

export { localFieldConfig } from './AgentCode.config';
...
const AgentCode = ({ isShow, layout, form, editable, section, config }: any) => (
  <Authority>
...
AgentCode.displayName = localFieldConfig.field;
