...
import { localFieldConfig } from './IssueEffectiveDate.config';

export { localFieldConfig } from './IssueEffectiveDate.config';
...
const IssueEffectiveDate = ({ isShow, layout, form, editable, section, config }: any) => (
  <Authority>
...
IssueEffectiveDate.displayName = localFieldConfig.field;

export default IssueEffectiveDate;
