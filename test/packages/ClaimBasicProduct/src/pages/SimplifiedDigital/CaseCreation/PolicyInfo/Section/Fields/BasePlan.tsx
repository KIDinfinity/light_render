...
import { localFieldConfig } from './BasePlan.config';

export { localFieldConfig } from './BasePlan.config';
...
const BasePlan = ({ isShow, layout, form, editable, section, config }: any) => (
  <Authority>
...
BasePlan.displayName = localFieldConfig.field;
