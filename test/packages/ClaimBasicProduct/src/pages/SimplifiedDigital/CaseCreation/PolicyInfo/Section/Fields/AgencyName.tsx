...
import { localFieldConfig } from './AgencyName.config';

export { localFieldConfig } from './AgencyName.config';
...
const AgencyName = ({ isShow, layout, form, editable, section, config }: any) => (
  <Authority>
...
AgencyName.displayName = localFieldConfig.field;
