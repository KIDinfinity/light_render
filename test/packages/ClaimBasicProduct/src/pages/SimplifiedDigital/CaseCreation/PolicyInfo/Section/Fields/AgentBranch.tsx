...
import { localFieldConfig } from './AgentBranch.config';

export { localFieldConfig } from './AgentBranch.config';
...
const Branch = ({ isShow, layout, form, editable, section, config }: any) => (
  <Authority>
...
Branch.displayName = localFieldConfig.field;
