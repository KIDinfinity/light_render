...
import { localFieldConfig } from './AgencyMobileNo.config';

export { localFieldConfig } from './AgencyMobileNo.config';
...
const AgencyMobileNo = ({ isShow, layout, form, editable, section, config }: any) => (
  <Authority>
...
AgencyMobileNo.displayName = localFieldConfig.field;

export default AgencyMobileNo;
