...
import { localFieldConfig } from './OwnerName.config';

export { localFieldConfig } from './OwnerName.config';
...
const OwnerName = ({ isShow, layout, form, editable, section, config }: any) => (
  <Authority>
...
OwnerName.displayName = localFieldConfig.field;
