...
import { localFieldConfig } from './ContactNo.config';

export { localFieldConfig } from './ContactNo.config';
...
const ContactNo = ({ isShow, layout, form, editable, section, config }: any) => (
  <Authority>
...
ContactNo.displayName = localFieldConfig.field;
