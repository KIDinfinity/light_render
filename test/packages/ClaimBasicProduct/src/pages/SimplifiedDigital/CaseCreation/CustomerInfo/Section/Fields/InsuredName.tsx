...
import { localFieldConfig } from './InsuredName.config';

export { localFieldConfig } from './InsuredName.config';
...
const InsuredName = ({ isShow, layout, form, editable, section, config }: any) => (
  <Authority>
...
InsuredName.displayName = localFieldConfig.field;
