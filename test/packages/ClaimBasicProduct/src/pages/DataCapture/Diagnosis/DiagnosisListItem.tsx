...
@connect(
  (
    { bpOfDataCaptureController, dictionaryController, formCommonController, claimEditable }: any,
    { diagnosisId }: any
  ) => ({
    diagnosisItem: bpOfDataCaptureController.claimEntities.diagnosisListMap[diagnosisId],
...
class DiagnosisListItem extends PureComponent {
  ...
  handleDelete = () => {
    ...
    deleteWarning({
      ...
      sectionID: SectionID.Diagnosis,
    }).then(() => {
      dispatch({
        type: 'bpOfDataCaptureController/removeDiagnosisItem',
        payload: {
          incidentId,
          diagnosisId,
        },
