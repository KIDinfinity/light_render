...
@connect(
  (
    ...
    procedureItem: bpOfClaimAssessmentController.claimEntities.procedureListMap[procedureId],
    incidentDate:
      bpOfClaimAssessmentController.claimEntities.incidentListMap[incidentId].incidentDate,
...
class ProcedureListItem extends PureComponent<IProps> {
  ...
  handleDelete = () => {
    ...
    dispatch({
      type: 'bpOfClaimAssessmentController/removeProcedureItem',
      payload: {
        treatmentId,
        procedureId,
      },
