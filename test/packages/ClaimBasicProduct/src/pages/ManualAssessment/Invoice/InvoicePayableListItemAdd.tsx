...
import { FormItemCurrency, formUtils } from 'basic/components/Form';
...
class InvoiceItemPayableItem extends PureComponent {
  ...
  handleDelete = () => {
    ...
    deleteWarning({
      ...
      sectionID: SectionID.InvoicePayable,
    }).then(() => {
      dispatch({
        type: 'bpOfClaimAssessmentController/removeInvoicePayableAddItem',
      });
    });
  };
