...
@connect(({ dictionaryController, bpOfClaimAssessmentController, formCommonController }: any) => ({
  ...
  insured: lodash.get(bpOfClaimAssessmentController, 'claimProcessData.insured'),
