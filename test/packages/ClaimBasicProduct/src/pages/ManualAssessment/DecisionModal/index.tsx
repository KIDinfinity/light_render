...
@connect(({ bpOfClaimAssessmentController }) => ({
  decisionModalShowStatus: bpOfClaimAssessmentController.decisionModalShowStatus,
}))
class DecisionModal extends Component {
  ...
  hideConfirmModal = () => {
    ...
    dispatch({ type: 'bpOfClaimAssessmentController/hideDecisionModal' });
  };
