...
@connect(
  (
    ...
    diagnosisItem: bpOfClaimAssessmentController.claimEntities.diagnosisListMap[diagnosisId],
...
class DiagnosisListItem extends PureComponent {
  ...
  handleDelete = () => {
    ...
    dispatch({
      type: 'bpOfClaimAssessmentController/removeDiagnosisItem',
      payload: {
        incidentId,
        diagnosisId,
      },
  ...
  searchIsCIByDiagnosisCode = (value) => {
    ...
    dispatch({
      type: 'bpOfClaimAssessmentController/checkIsCIByDiagnosisCode',
      payload: {
        diagnosisId,
        incidentId,
        searchCode: value,
